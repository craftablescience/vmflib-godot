...
class Entity(VmfClass):
    ...
    def __init__(self, class_name, vmf_map):
        ...
        p['classname'] = self.classname
        Entity.entitycount += 1            # Increment entity counter

        vmf_map.children.append(self)

    def add_output(self, output: types.Output):

        # Add our connections object
...
class World(Entity):
    ...
    def __init__(self, vmf_map):
        Entity.__init__(self, 'worldspawn', vmf_map)
...
class ValveMap(VmfClass):
    ...
    def __init__(self):
        ...
        self.world = World(self)    # Automatically added to map
        #self.hidden = 0
