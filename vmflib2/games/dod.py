...
This file was auto-generated by import_fgd.py on 2018-06-20 16:16:58.608440.
"""
...
class DodBombDispenser(Entity):
    ...
    Bomb Dispenser Area
    """
    def __init__(self, vmf_map, StartDisabled=0, targetname="", dispense_team=0):
...
class DodBombTarget(Entity):
    ...
    Bomb Target
    """
    def __init__(self, vmf_map, origin="0 0 0", StartDisabled=0, angles="0 0 0", targetname="", target_control_point="", bombing_team=2, add_timer_seconds=0):
        ...
        # Target CP : 
        self.target_control_point = target_control_point
        # Bombing Team : 
        self.bombing_team = bombing_team
        # Add To Timer (sec) : 
        self.add_timer_seconds = add_timer_seconds
...
class DodCaptureArea(Entity):
    ...
    Capture Area
    """
    def __init__(self, vmf_map, StartDisabled=0, targetname="", area_allies_cancap=1, area_axis_cancap=1, area_allies_numcap=1, area_axis_numcap=1, area_time_to_cap=5, area_cap_point=""):
        ...
        self.area_allies_numcap = area_allies_numcap
        # Number of Axis to cap : 
        self.area_axis_numcap = area_axis_numcap
        # Time to cap (sec) : 
...
class DodControlPoint(Entity):
    ...
    Control Point
    """
    def __init__(self, vmf_map, origin="0 0 0", StartDisabled=0, targetname="", angles="0 0 0", spawnflags="", point_printname="TODO", point_timedpoints_allies=0, point_timedpoints_axis=0, point_default_owner=0, point_axis_capsound="", point_allies_capsound="", point_resetsound="", point_allies_model="models/mapmodels/flags.mdl", point_allies_model_bodygroup=1, point_axis_model="models/mapmodels/flags.mdl", point_axis_model_bodygroup=0, point_reset_model="models/mapmodels/flags.mdl", point_reset_model_bodygroup=3, point_group=0, point_index=0, point_hud_icon_neutral="sprites/obj_icons/icon_obj_neutral", point_hud_icon_axis="sprites/obj_icons/icon_obj_axis", point_hud_icon_allies="sprites/obj_icons/icon_obj_allies", point_hud_icon_timercap="sprites/obj_icons/icon_obj_neutral", point_hud_icon_bombed="sprites/obj_icons/icon_obj_neutral", point_num_bombs=0):
        ...
        self.point_timedpoints_allies = point_timedpoints_allies
        # Time based point value for Axis : 
        self.point_timedpoints_axis = point_timedpoints_axis
        # Default Owner of the control point : 
        self.point_default_owner = point_default_owner
        # Sound Made when Axis captures : 
        self.point_axis_capsound = point_axis_capsound
        # Sound Made when Allies captures : 
        self.point_allies_capsound = point_allies_capsound
        # Sound Made when point resets : 
        self.point_resetsound = point_resetsound
        # Allies Model : Model when Allies own point
        self.point_allies_model = point_allies_model
        # Allies model bodygroup : 
        self.point_allies_model_bodygroup = point_allies_model_bodygroup
        # Axis Model : Model when Axis own point
        self.point_axis_model = point_axis_model
        # Axis model bodygroup : 
        self.point_axis_model_bodygroup = point_axis_model_bodygroup
        # Reset Model : Model when point reset
        self.point_reset_model = point_reset_model
        # Reset model bodygroup : 
        self.point_reset_model_bodygroup = point_reset_model_bodygroup
        # Group Index : 
        self.point_group = point_group
        # Index of this point ( unique ) : 
        self.point_index = point_index
        # Hud icon material when noone owns point : 
        self.point_hud_icon_neutral = point_hud_icon_neutral
        # Hud icon material when Axis own point : 
        self.point_hud_icon_axis = point_hud_icon_axis
        # Hud icon material when Allies own point : 
        self.point_hud_icon_allies = point_hud_icon_allies
        # Hud icon - bomb planted : 
        self.point_hud_icon_timercap = point_hud_icon_timercap
        # Hud icon - point destroyed : 
        self.point_hud_icon_bombed = point_hud_icon_bombed
...
class DodControlPointMaster(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, cpm_use_timer=0, cpm_timer_length=300, cpm_timer_team=0):
        ...
        self.cpm_timer_length = cpm_timer_length
...
class DodLocation(Entity):
    ...
    Location
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", location_name=""):
...
class DodScoring(Entity):
    ...
    Custom Scoring
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, point_give_delay=60, point_give_amount=1, point_give_max_times=10):
        ...
        self.point_give_delay = point_give_delay
        # Points to give each time : 
        self.point_give_amount = point_give_amount
        # Max number of times to give points : 
        self.point_give_max_times = point_give_max_times
...
class FuncTeamWall(Entity):
    ...
    Team Blocker Wall
    """
    def __init__(self, vmf_map, blockteam=0):
...
class FuncTeamblocker(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", TeamNum=0, spawnflags=""):
...
class InfoDoddetect(Entity):
    ...
    DoD Gamerules
    """
    def __init__(self, vmf_map, origin="0 0 0", StartDisabled=0, detect_allies_respawnfactor="1.0", detect_axis_respawnfactor="1.0", detect_allies_startroundvoice=0, detect_axis_startroundvoice=0):
        ...
        self.detect_allies_respawnfactor = detect_allies_respawnfactor
        # Axis Respawn delay factor : 
        self.detect_axis_respawnfactor = detect_axis_respawnfactor
...
class InfoPlayerAllies(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", angles="0 0 0", targetname="", StartDisabled=0):
