"""
Helper classes for creating maps in any Source Engine game that uses mapbase_halflife2.fgd.
This file was auto-generated by import_fgd.py on 2020-01-19 09:11:16.401248.
"""
...
class AiAllyManager(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2679.
    AI Ally Manager
    """
...
class AiBattleLine(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2866.
    Battle line
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", parentname: str="", spawnflags="", actor: str="*", Active=0, Strict=1):
        ...
        # Actor(s) or squad to affect : Wildcards are supported.
...
class AiChangehintgroup(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3269.
    Change Hint Group
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", SearchType=0, SearchName: str="", NewHintGroup: str="", Radius: str="0.0", hintlimiting=0, changehints=0):
        ...
        # Change info_(node)_hints : Changes the hintgroups of info_hints, info_node_hints, etc. as well.
        self.changehints = changehints

        self.auto_properties.extend(["origin", "targetname", "SearchType", "SearchName", "NewHintGroup", "Radius", "hintlimiting", "changehints"])


class AiChangetarget(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3253.
    Change Target
    """
...
class AiCitizenResponseSystem(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3521.
...
class AiGoalActbusy(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3157.
    AI Goal Act Busy
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", actor: str="", StartActive=0, SearchType=0, busysearchrange: float=2048, visibleonly=0, NextBusy: float="0,0", seeentity: str="", seeentitytimeout: float="1", sightmethod=0, type=0, safezone: str="", allowteleport=0):
        ...
        self.seeentitytimeout: float = seeentitytimeout
        ...
        self.auto_properties.extend(["origin", "targetname", "actor", "StartActive", "SearchType", "busysearchrange", "visibleonly", "NextBusy", "seeentity", "seeentitytimeout", "sightmethod", "type", "safezone", "allowteleport"])


class AiGoalActbusyQueue(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3190.
    AI Goal Act Busy Queue
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", actor: str="", StartActive=0, SearchType=0, busysearchrange: float=2048, visibleonly=0, NextBusy: float="0,0", node_exit: str="", node01: str="", node02: str="", node03: str="", node04: str="", node05: str="", node06: str="", node07: str="", node08: str="", node09: str="", node10: str="", node11: str="", node12: str="", node13: str="", node14: str="", node15: str="", node16: str="", node17: str="", node18: str="", node19: str="", node20: str="", mustreachfront=0):
        ...
        self.auto_properties.extend(["origin", "targetname", "actor", "StartActive", "SearchType", "busysearchrange", "visibleonly", "NextBusy", "node_exit", "node01", "node02", "node03", "node04", "node05", "node06", "node07", "node08", "node09", "node10", "node11", "node12", "node13", "node14", "node15", "node16", "node17", "node18", "node19", "node20", "mustreachfront"])


class AiGoalAssault(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3077.
    AI Goal Assault
    """
...
class AiGoalFear(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3231.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", actor: str="", target: str="", StartActive=0):
        Entity.__init__(self, "ai_goal_fear", vmf_map)
        ...
        # Actor(s) to affect : NPC(s) that should engage in fear behavior.
        self.actor: str = actor
        # Fear Target : Target to fear. Only applies whenever the actors' relationship to the target is D_FR. Supports wildcards and can be a classname or an entity name.
        self.target: str = target
        # Start Active : 
        self.StartActive = StartActive

        self.auto_properties.extend(["origin", "targetname", "actor", "target", "StartActive"])


class AiGoalFollow(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2858.
    AI Goal Follow
    """
...
class AiGoalInjuredFollow(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2862.
...
class AiGoalLeadWeapon(Entity):
    ...
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", actor: str="", goal: str="", WaitPointName: str="", WaitDistance: float="", LeadDistance: float="64", RetrieveDistance: float="96", SuccessDistance: float="0", Run="0", Retrieve=1, ComingBackWaitForSpeak=1, RetrieveWaitForSpeak=1, DontSpeakStart=0, LeadDuringCombat=0, GagLeader=0, AttractPlayerConceptModifier: str="", WaitOverConceptModifier: str="", ArrivalConceptModifier: str="", PostArrivalConceptModifier: str="", SuccessConceptModifier: str="", FailureConceptModifier: str="", ComingBackConceptModifier: str="", RetrieveConceptModifier: str="", spawnflags="", WeaponName: str="weapon_bugbait", TimeoutTime: float="60.0", MissingWeaponConceptModifier: str="", SearchType=0):
        ...
        # Weapon : The weapon the player must have in order for the actor to begin leading. If the entity times out, this weapon will silently be given to the player automatically.
        self.WeaponName: str = WeaponName
        # Timeout Time : How long after the ai_goal_lead_weapon is activated should it time out and just give the player the weapon? Enter 0 to use no timeout.
        self.TimeoutTime: float = TimeoutTime
        # Missing weapon concept modifier : Appended to the keyvalues passed into the response rules when the 'TLK_LEAD_MISSINGWEAPON' concept is spoken.
        self.MissingWeaponConceptModifier: str = MissingWeaponConceptModifier
        # Search Type : How to search for the entities using the targetname.
        self.SearchType = SearchType

        self.auto_properties.extend(["origin", "targetname", "angles", "actor", "goal", "WaitPointName", "WaitDistance", "LeadDistance", "RetrieveDistance", "SuccessDistance", "Run", "Retrieve", "ComingBackWaitForSpeak", "RetrieveWaitForSpeak", "DontSpeakStart", "LeadDuringCombat", "GagLeader", "AttractPlayerConceptModifier", "WaitOverConceptModifier", "ArrivalConceptModifier", "PostArrivalConceptModifier", "SuccessConceptModifier", "FailureConceptModifier", "ComingBackConceptModifier", "RetrieveConceptModifier", "spawnflags", "WeaponName", "TimeoutTime", "MissingWeaponConceptModifier", "SearchType"])


class AiGoalOperator(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2140.
...
class AiGoalPolice(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2965.
    AI Goal Police
    """
...
class AiGoalStandoff(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2893.
    AI Goal Standoff
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", actor: str="", SearchType=0, StartActive=0, HintGroupChangeReaction=1, Aggressiveness=2, PlayerBattleline=1, StayAtCover=0, AbandonIfEnemyHides=0, CustomCoverOnReload=1, CustomMinTimeShots: float=2, CustomMaxTimeShots: float=4, CustomMinShots: int=1, CustomMaxShots: int=4, CustomOddsCover: int=25):
        ...
        # Custom: Take cover to reload : 
        self.CustomCoverOnReload = CustomCoverOnReload
        # Custom: Min time wait to shoot : Minimum duration of time after a burst of shooting before trying again
        self.CustomMinTimeShots: float = CustomMinTimeShots
        # Custom: Max time wait to shoot : Minimum duration of time after a burst of shooting before trying again
        self.CustomMaxTimeShots: float = CustomMaxTimeShots
        # Custom: Min shots in a burst : 
        self.CustomMinShots: int = CustomMinShots
        # Custom: Max shots in a burst : 
        self.CustomMaxShots: int = CustomMaxShots
        # Custom: Odds cover on damage : If damaged, the chances react by taking immediate cover
        self.CustomOddsCover: int = CustomOddsCover

        self.auto_properties.extend(["origin", "targetname", "actor", "SearchType", "StartActive", "HintGroupChangeReaction", "Aggressiveness", "PlayerBattleline", "StayAtCover", "AbandonIfEnemyHides", "CustomCoverOnReload", "CustomMinTimeShots", "CustomMaxTimeShots", "CustomMinShots", "CustomMaxShots", "CustomOddsCover"])


class AiNpcEventresponsesystem(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3263.
...
class AiRelationship(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2543.
...
class AiRelationshipClassify(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2586.
    AI Relationship - Sets relationships between entire classify classes in the AI.
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", subject=0, target=0, disposition=3, radius: float=0, rank: int=0, StartActive=0, Reciprocal=0):
        Entity.__init__(self, "ai_relationship_classify", vmf_map)
        ...
        # Subject(s) : This is the NPC class whose disposition will change.
        self.subject = subject
        # Target(s) : This is the NPC class about whom the Subject class will change their disposition.
        self.target = target
        # Disposition : Choose the way the subject class should feel about the target class
        self.disposition = disposition
        # Radius for subject : 
        self.radius: float = radius
        # Disposition Priority : How much the subject class should Like/Hate/Fear the target class. Higher priority = stronger feeling.
        self.rank: int = rank
        # Start Active : 
        self.StartActive = StartActive
        # Reciprocal : Set this to YES to have the new relationship mirrored by the target class.
        self.Reciprocal = Reciprocal

        self.auto_properties.extend(["origin", "targetname", "subject", "target", "disposition", "radius", "rank", "StartActive", "Reciprocal"])


class AiScriptConditions(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3297.
...
class AiSound(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4578.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", volume: int=120, duration: float="0.5", soundtype=0, soundcontext=0, locationproxy: str="", target: str=""):
        ...
        # Sound Owner : An optional entity to use that the sound doesn't emit from, but is specified as the 'owner'. This is needed for certain sound contexts and other miscellaneous stuff. If not specified, the ai_sound will be used as the owner.
        self.target: str = target

        self.auto_properties.extend(["origin", "targetname", "parentname", "volume", "duration", "soundtype", "soundcontext", "locationproxy", "target"])


class AiscriptedSchedule(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3465.
...
class AssaultAssaultpoint(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3011.
...
class AssaultRallypoint(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2988.
    (Assault) rally point
    """
...
class CombineMine(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4649.
    A bouncing Combine mine. Mapbase adds a few new I/O/KV, but probably not enough.
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, bounce=1, ExplosionDelay: float="0.5", LockSilently=1, InitialState=0, Modification=0, Friendly=0, enemyfilter: str="", friendfilter: str="", FilterExclusive=0):
        ...
        self.bounce = bounce
        # Delay : The delay after being triggered before this mine bounces, or before it explodes if bouncing is disabled. Does not apply to the cavern type.
        self.ExplosionDelay: float = ExplosionDelay
        # Lock Silently : Prevents the mine from making any clamping sound when it plants itself for the first time, after which it makes sound again.
        self.LockSilently = LockSilently
        # Initial State : The initial state of this mine.
        ...
        # Start Friendly : Makes this combine_mine friendly, as if it was placed by the player.
        self.Friendly = Friendly
        # Enemy Filter : Makes this combine_mine target specific NPCs as enemies. It will also use its default targets unless ''Filter Exclusive'' is enabled.
        self.enemyfilter: str = enemyfilter
        # Friend Filter : Makes this combine_mine target specific NPCs as friends. It will also use its default targets unless ''Filter Exclusive'' is enabled.
        self.friendfilter: str = friendfilter
        # Filter Exclusive : If enabled, the filters will be the exclusive factor in determining whether a mine is friendly or hostile towards a target. Entities that pass neither filter will be ignored by the mine.
        self.FilterExclusive = FilterExclusive

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "fademindist", "fademaxdist", "fadescale", "bounce", "ExplosionDelay", "LockSilently", "InitialState", "Modification", "Friendly", "enemyfilter", "friendfilter", "FilterExclusive"])


class Concussiveblast(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1523.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", damage: float=200, radius: float=256, magnitude: str="1.0", soundname: str="", spawnflags=""):
        Entity.__init__(self, "concussiveblast", vmf_map)
        ...
        # Damage : The amount of damage done by the explosion.
        self.damage: float = damage
        # Radius : The radius in which the explosion can damage entities.
        self.radius: float = radius
        # Shockwave Magnitude : Multiplier for how far the shockwave should go. Does nothing to the radius or damage. 2.5 = Strider Cannon
        self.magnitude: str = magnitude
        # Sound : Sound to make when we explode.
        self.soundname: str = soundname
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags

        self.auto_properties.extend(["origin", "targetname", "parentname", "damage", "radius", "magnitude", "soundname", "spawnflags"])


class CyclerActor(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2283.
    Actor Cycler
    """
...
class EnvAlyxemp(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5385.
...
class EnvAr2explosion(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4715.
...
class EnvCitadelEnergyCore(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5369.
...
class EnvEntityDissolver(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5465.
    Entity Dissolver
    """
...
class EnvFlare(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4729.
    Flare
    """
...
class EnvGlobal(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3666.
...
class EnvGunfire(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1295.
    Gunfire Effect
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", parentname: str="", targetname: str="", StartDisabled=0, target: str="", minburstsize: int=2, maxburstsize: int=7, minburstdelay: float=2, maxburstdelay: float=5, rateoffire: float=10, spread=5, bias=1, collisions=0, shootsound: str="Weapon_AR2.NPC_Single", tracertype="AR2TRACER"):
        ...
        self.shootsound: str = shootsound
...
class EnvHeadcrabcanister(Entity):
    ...
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", spawnflags="", HeadcrabType=0, HeadcrabCount: int=6, FlightSpeed: float=3000, FlightTime: float=5, StartingHeight: float=0, MinSkyboxRefireTime: float=0, MaxSkyboxRefireTime: float=0, SkyboxCannisterCount: int=1, Damage: float=150, DamageRadius: float=750, SmokeLifetime: float=30, LaunchPositionName: str=""):
        ...
        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "spawnflags", "HeadcrabType", "HeadcrabCount", "FlightSpeed", "FlightTime", "StartingHeight", "MinSkyboxRefireTime", "MaxSkyboxRefireTime", "SkyboxCannisterCount", "Damage", "DamageRadius", "SmokeLifetime", "LaunchPositionName"])


class EnvMuzzleflash(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4748.
    Muzzle Flash
    """
...
class EnvRotorwash(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4639.
    Rotorwash Effect
    """
...
class EnvSpeaker(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5310.
...
class EnvSporeexplosion(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1290.
...
class EnvStarfield(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4722.
    Starfield effect
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str=""):
...
class EnvStarfield(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5302.
    Starfield effect
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str=""):
        Entity.__init__(self, "env_starfield", vmf_map)
...
class EnvTerrainmorph(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4757.
...
class FilterCombineballType(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5454.
...
class FuncBulletshield(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5027.
...
class FuncCombineBallSpawner(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 213.
...
class FuncCommandredirect(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1028.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", StartDisabled=0, globalname: str="", target: str="", reponly=0):
        Entity.__init__(self, "func_commandredirect", vmf_map)
        ...
        # Target : Redirects command goals to this entity's origin. If blank, doesn't affect the goal. If -1, cancels the command entirely.
        self.target: str = target
        # Squad Representative Only : If enabled, only fires OutAlly for the player's squad's representative.
        self.reponly = reponly

        self.auto_properties.extend(["targetname", "parentname", "origin", "StartDisabled", "globalname", "target", "reponly"])


class FuncHealthcharger(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3534.
...
class FuncLookdoor(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3573.
...
class FuncMonitor(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5015.
...
class FuncRecharge(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3544.
    Battery recharger
    """
...
class FuncTank(Entity):
    ...
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", shootsound: str="", ammotype=""):
        ...
        # Smoke Sprite : A specific sprite to use for the muzzle's smoke effect.
        self.spritesmoke: str = spritesmoke
        # Flash Sprite : A specific sprite to use for the muzzle's flash effect.
        self.spriteflash: str = spriteflash
        # Sprite scale : The scale for smoke and flash sprites.
        ...
        # Automatically search for NPCs : If controllable by NPCs, sets whether we should automatically search for NPCs to use this func_tank or just wait for the player to set it. Identical to StartFindingNPCs and StopFindingNPCs.
        self.ShouldFindNPCs = ShouldFindNPCs
        # Effect Handling : Special effect handling that influences sound and muzzle effects. Individual settings can override parts of it.
        self.effecthandling = effecthandling
        # Trace Filter : Entities that pass this filter will be ignored by this func_tank while it's aiming.
        self.TraceFilter: str = TraceFilter
        # Don't hit controller : If enabled, bullets will not hit whoever is controlling this func_tank.
        self.DontHitController = DontHitController
        # NPC controller glued : If enabled, NPCs that mount this func_tank will disregard certain conditions that cause it to dismount automatically, like damage from behind or enemies getting beyond reach. They will still dismount for things like grenades.
        self.ControllerGlued = ControllerGlued
        # Player Crosshair Trace Offset : When a func_tank wants to aim at the player's crosshair, it draws a line to the point they're looking at. The line should start this many units ahead to avoid colliding with the player or any nearby objects. Decreasing the value is only recommended if 'Dont Hit Controller' is enabled.
        self.PlayerBBoxDist: float = PlayerBBoxDist

        # Shoot Sound : Plays a specific sound to use each time this tank fires.
        self.shootsound: str = shootsound

        # Ammo type : 
        self.ammotype = ammotype

        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "shootsound", "ammotype"])


class FuncTankCombineCannon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3965.
    Combine sentry cannon
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", shootsound: str="", firerate: str="1.5", ammotype="", ControllableVersion=0):
        ...
        # Ammo type : 
        self.ammotype = ammotype
        # Controllable Version : Enables a tweaked version of func_tank_combine_cannon that is designed to be controlled by players and NPCs.
        self.ControllableVersion = ControllableVersion

        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "shootsound", "firerate", "ammotype", "ControllableVersion"])


class FuncTankairboatgun(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3905.
    Airboat Gun Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", shootsound: str="", firespread=-1, heavy_shot_spread=0, heavy_shot_interval: float="0.2", airboat_gun_model: str=""):
        ...
        # Bullet accuracy : 
        self.firespread = firespread
        # Heavy shot accuracy : The accuracy for each 'heavy' shot, which fires at a specified interval.
        self.heavy_shot_spread = heavy_shot_spread
        # Heavy shot interval : The interval between each 'heavy' shot, which carries higher knockback and, by default, perfect accuracy. The vast majority of bullets that hit the enemy are these 'heavy' shots.
        self.heavy_shot_interval: float = heavy_shot_interval
        # Airboat gun model (Obsolete) : You can do everything and more with the parent now, so you'd be better off using regular func_tank parent behavior than this. It is still functional for legacy support.
        self.airboat_gun_model: str = airboat_gun_model

        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "shootsound", "firespread", "heavy_shot_spread", "heavy_shot_interval", "airboat_gun_model"])


class FuncTankapcrocket(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3931.
    APC Rocket Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", rocketspeed: float=800, burstcount: int=10):
        ...
        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "rocketspeed", "burstcount"])


class FuncTanklaser(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3894.
    Brush Laser Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", laserentity: str=""):
        ...
        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "laserentity"])


class FuncTanklogic(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3990.
    A special kind of turret designed to fire outputs instead of bullets, functioning solely through the I/O system.
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", shootsound: str="", ShootsThroughWater=0):
        Entity.__init__(self, "func_tanklogic", vmf_map)
        ...
        # Shoots through water : If enabled, this func_tanklogic will be allowed to trace through water. (as opposed to just hitting the surface)
        self.ShootsThroughWater = ShootsThroughWater

        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "shootsound", "ShootsThroughWater"])


class FuncTankmortar(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3940.
    Brush Mortar Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", iMagnitude: int=100, firedelay: str=2, firestartsound: str="", incomingsound: str="", warningtime: float="1", firevariance: float="0", radius: float="0", trace_mask=16395):
        ...
        # Explosion Radius : The radius of each shell's explosion. Reflected in its effects as well as its damage. 0 = Default (350)
        self.radius: float = radius
        # Trace Mask : The mask to use for when the mortar is tracing attacks from above. Good for when you want the mortar to hit NPCs like striders.
        self.trace_mask = trace_mask

        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "iMagnitude", "firedelay", "firestartsound", "incomingsound", "warningtime", "firevariance", "radius", "trace_mask"])


class FuncTankphyscannister(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3960.
    PhysCannister Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", barrel_volume: str=""):
        ...
        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "barrel_volume"])


class FuncTankpulselaser(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3883.
    Brush Pulse Laser
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", PulseSpeed: float=1000, PulseColor: "RGB"="255 0 0", PulseWidth: float="20", PulseLife: float=2, PulseLag: float="0.05", PulseFireSound: str=""):
        ...
        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "PulseSpeed", "PulseColor", "PulseWidth", "PulseLife", "PulseLag", "PulseFireSound"])


class FuncTankrocket(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3900.
    Brush Rocket Turret
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, globalname: str="", disableshadows=0, spawnflags="", control_volume: str="", master: str="", yawrate: str="30", yawrange: str="180", yawtolerance: str="15", pitchrate: str="0", pitchrange: str="0", pitchtolerance: str="5", barrel: str="0", barrely: str="0", barrelz: str="0", spritesmoke: str="", spriteflash: str="", spritescale: str="1", rotatestartsound: str="", rotatesound: str="", rotatestopsound: str="", firerate: str="1", bullet_damage: str="0", bullet_damage_vs_player: str="0", persistence: str="1", persistence2: str="0", firespread=0, minRange: str="0", maxRange: str="0", _minlight: str="", gun_base_attach: str="", gun_barrel_attach: str="", gun_yaw_pose_param: str="", gun_yaw_pose_center: float="0", gun_pitch_pose_param: str="", gun_pitch_pose_center: float="0", ammo_count: int=-1, LeadTarget="No", npc_man_point: str="", playergraceperiod: float="0", ignoregraceupto: float="768", playerlocktimebeforefire: float="0", ShouldFindNPCs=1, effecthandling=0, TraceFilter: str="", DontHitController=1, ControllerGlued=0, PlayerBBoxDist: float="24", rocketspeed: float=800):
        ...
        self.auto_properties.extend(["targetname", "parentname", "origin", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "globalname", "disableshadows", "spawnflags", "control_volume", "master", "yawrate", "yawrange", "yawtolerance", "pitchrate", "pitchrange", "pitchtolerance", "barrel", "barrely", "barrelz", "spritesmoke", "spriteflash", "spritescale", "rotatestartsound", "rotatesound", "rotatestopsound", "firerate", "bullet_damage", "bullet_damage_vs_player", "persistence", "persistence2", "firespread", "minRange", "maxRange", "_minlight", "gun_base_attach", "gun_barrel_attach", "gun_yaw_pose_param", "gun_yaw_pose_center", "gun_pitch_pose_param", "gun_pitch_pose_center", "ammo_count", "LeadTarget", "npc_man_point", "playergraceperiod", "ignoregraceupto", "playerlocktimebeforefire", "ShouldFindNPCs", "effecthandling", "TraceFilter", "DontHitController", "ControllerGlued", "PlayerBBoxDist", "rocketspeed"])


class FuncVehicleclip(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3566.
    Vehicle Clip
    """
...
class Hl2Gamerules(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3610.
    Proxy entity for HL2 Gamerules
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", DefaultCitizenType=0, SetPlayerSquadAutosummon=1, SetLegacyFlashlight="", SetStunstickPickupBehavior=0):
        Entity.__init__(self, "hl2_gamerules", vmf_map)
        ...
        # Default Citizen Type : Overrides the default citizen type.
        self.DefaultCitizenType = DefaultCitizenType
        # Player Squad Autosummon Allowed : Sets whether citizens are allowed to automatically follow the player again when they're at a command point and left alone for a while.
        self.SetPlayerSquadAutosummon = SetPlayerSquadAutosummon
        # Legacy Flashlight : Sets whether the EP2 flashlight or the original flashlight from HL2 and Episode One should be used. 'No' means use the EP2 version, 'Yes' means use the original flashlight, and 'Default' doesn't change anything. This is pretty much only relevant to the Episodic version.
        self.SetLegacyFlashlight = SetLegacyFlashlight
        # Stunstick Pickup Behavior : Controls how stunsticks should react to being touched by the player.
        self.SetStunstickPickupBehavior = SetStunstickPickupBehavior

        self.auto_properties.extend(["origin", "targetname", "DefaultCitizenType", "SetPlayerSquadAutosummon", "SetLegacyFlashlight", "SetStunstickPickupBehavior"])


class InfoApcMissileHint(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5154.
...
class InfoDarknessmodeLightsource(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2172.
...
class InfoRadarTarget(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 520.
    Jalopy Radar Beacon
    """
...
class InfoSnipertarget(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 546.
    Sniper Target
    """
...
class InfoTargetGunshipcrash(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1609.
...
class InfoTargetHelicopterCrash(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1605.
...
class InfoTargetVehicleTransition(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 542.
...
class InfoTeleporterCountdown(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5413.
...
class ItemAmmo357(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4078.
    Box of 357 ammo
    """
...
class ItemAmmo357Large(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4079.
...
class ItemAmmoAr2(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4076.
    Box of AR2 ammo
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemAmmoAr2Altfire(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4087.
    AR2 Alt-fire Round
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemAmmoAr2Large(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4077.
...
class ItemAmmoCrate(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4096.
    Ammo Crate
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, AmmoType=0, skin: int=0):
        ...
        # Ammo Type : 
        self.AmmoType = AmmoType
        # Skin : The ''Empty'' ammo crate can use multiple skins based on other crates. Changing the skin might be reflected in the viewport, but it will only apply to the empty ammo crate.
        self.skin: int = skin

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "fademindist", "fademaxdist", "fadescale", "AmmoType", "skin"])


class ItemAmmoCrossbow(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4080.
...
class ItemAmmoPistol(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4072.
    Box of Pistol ammo
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemAmmoPistolLarge(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4073.
...
class ItemAmmoSmg1(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4074.
    Box of SMG1 ammo
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemAmmoSmg1Grenade(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4083.
    SMG1 Grenade
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemAmmoSmg1Large(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4075.
...
class ItemBattery(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4084.
    HEV battery
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemBoxBuckshot(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4081.
    Box Buckshot
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemDynamicResupply(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4038.
...
class ItemHealthcharger(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4168.
    Health Charger
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, skin: int=0, modelscale: float="1.0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, model: str="models/props_combine/health_charger001.mdl", Charge: int=0, MaxCharge: int=0, SetIncrementValue: int=0):
        ...
        # Model : 
        self.model: str = model
        # Juice : Overrides the amount of suit power this charger contains. Use 0 for the default charge, which is usually the maximum juice. Use -1 if you want the charger to start empty.
        self.Charge: int = Charge
        # Max Juice : Overrides the maximum suit power this charger contains. Use 0 for the default charge, 75.
        self.MaxCharge: int = MaxCharge
        # Increment Health : How much charge should be given each 'increment', or each tenth-of-a-second interval in which the player is given health while using this charger. Juice is also decreased accordingly. Use 0 for the default increment, 1.
        self.SetIncrementValue: int = SetIncrementValue

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "skin", "modelscale", "disableshadows", "fademindist", "fademaxdist", "fadescale", "model", "Charge", "MaxCharge", "SetIncrementValue"])


class ItemHealthkit(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4085.
    Small Health Kit
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemHealthvial(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4086.
    Personal Health Kit
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemItemCrate(Entity):
    ...
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", globalname: str="", skin: int=0, modelscale: float="1.0", disableshadows=0, ExplodeDamage: float=0, ExplodeRadius: float=0, PerformanceMode=0, BreakModelMessage: str="", pressuredelay: float=0, mindxlevel=0, maxdxlevel=0, spawnflags="", minhealthdmg: int=0, shadowcastdist: int=0, physdamagescale: float="0.1", Damagetype=0, nodamageforces=0, inertiaScale: float="1.0", massScale: float="0", overridescript: str="", damagetoenablemotion: int=0, forcetoenablemotion: float=0, puntsound: str="", targetname: str="", angles: "Origin"="0 0 0", damagefilter: str="", fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, model: str="models/items/item_item_crate.mdl", CrateType=0, CrateAppearance=0, ItemClass: str="item_dynamic_resupply", ItemCount: int=1, SpecificResupply: str=""):
        ...
        # Model : The model of this item_item_crate. Only works when this crate's appearance is set to use a custom model.
        self.model: str = model
        # Crate Contains : 
        ...
        # Specific resupply/Target template : If item type is item_dynamic_resupply, specify a specific one to use instead of the master. If the crate contains a point_template, this is required to specify which point_template to spawn.
        self.SpecificResupply: str = SpecificResupply

        self.auto_properties.extend(["origin", "globalname", "skin", "modelscale", "disableshadows", "ExplodeDamage", "ExplodeRadius", "PerformanceMode", "BreakModelMessage", "pressuredelay", "mindxlevel", "maxdxlevel", "spawnflags", "minhealthdmg", "shadowcastdist", "physdamagescale", "Damagetype", "nodamageforces", "inertiaScale", "massScale", "overridescript", "damagetoenablemotion", "forcetoenablemotion", "puntsound", "targetname", "angles", "damagefilter", "fademindist", "fademaxdist", "fadescale", "model", "CrateType", "CrateAppearance", "ItemClass", "ItemCount", "SpecificResupply"])


class ItemRpgRound(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4082.
    RPG Round
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemSuit(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4088.
    HEV Suit
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, spawnflags=""):
...
class ItemSuitcharger(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4193.
    Battery recharger
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, skin: int=0, modelscale: float="1.0", disableshadows=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, model: str="models/props_combine/suit_charger001.mdl", Charge: int=0, MaxCharge: int=0, SetIncrementValue: int=0, spawnflags=""):
        ...
        # Model : 
        self.model: str = model
        # Juice : Overrides the amount of suit power this charger contains. Use 0 for the maximum juice. (which is normally 75) Use -1 if you want the charger to start empty.
        self.Charge: int = Charge
        # Max Juice : Overrides the maximum suit power this charger contains. Use 0 for the default charge, which varies based on this entity's spawnflags. (Normal = 75, Citadel = 500, Kleiner = 25)
        self.MaxCharge: int = MaxCharge
        # Increment Armor : How much charge should be given each 'increment', or each tenth-of-a-second interval in which the player is given suit armor while using this charger. Juice is also decreased accordingly. Use 0 for the default increment. (Normal = 1, Citadel = 10)
        self.SetIncrementValue: int = SetIncrementValue
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "skin", "modelscale", "disableshadows", "fademindist", "fademaxdist", "fadescale", "model", "Charge", "MaxCharge", "SetIncrementValue", "spawnflags"])


class LogicAchievement(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4785.
...
class LogicChoreographedScene(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4477.
...
class LogicSceneListManager(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4554.
...
class MonsterGeneric(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2230.
    Generic Script NPC
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", model: str="", skin: int=0, modelscale: float="1.0", targetname: str="", angles: "Origin"="0 0 0", damagefilter: str="", ResponseContext: str="", target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, disableshadows=0, spawnflags=""):
        ...
        self.auto_properties.extend(["origin", "model", "skin", "modelscale", "targetname", "angles", "damagefilter", "ResponseContext", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "disableshadows", "spawnflags"])


class NpcAdvisor(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1256.
...
class NpcAlyx(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2091.
    Alyx
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, parentname: str="", NumGrenades="0", SetGrenadeCapabilities="None", AlwaysTransition="No", GameEndAlly="No", model: str="models/alyx.mdl", additionalequipment="weapon_alyxgun", DontPickupWeapons="1", ShouldHaveEMP="1"):
        ...
        # Grenade capabilities : Controls this NPC's capability to throw grenades or use their weapon's secondary ability (energy balls/SMG grenades).
        self.SetGrenadeCapabilities = SetGrenadeCapabilities
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "parentname", "NumGrenades", "SetGrenadeCapabilities", "AlwaysTransition", "GameEndAlly", "model", "additionalequipment", "DontPickupWeapons", "ShouldHaveEMP"])


class NpcAntlion(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 578.
...
class NpcAntlionGrub(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5535.
    Antlion grub
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, globalname: str="", damagefilter: str="", spawnflags=""):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "fademindist", "fademaxdist", "fadescale", "globalname", "damagefilter", "spawnflags"])


class NpcAntlionTemplateMaker(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2316.
...
class NpcAntlionguard(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 624.
    Antlion Guard
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", spawnflags="", startburrowed="No", allowbark="No", cavernbreed="No", incavern="No", shovetargets: str=""):
        ...
        # Shove Targets : All entities of this name will be considered shove targets.
...
class NpcApcdriver(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 417.
...
class NpcBarnacle(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1542.
    Barnacle
    """
...
class NpcBarney(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1054.
    Barney
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, NumGrenades="0", SetGrenadeCapabilities="None", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", additionalequipment="weapon_pistol", ExpressionOverride: str=""):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "NumGrenades", "SetGrenadeCapabilities", "AlwaysTransition", "DontPickupWeapons", "GameEndAlly", "additionalequipment", "ExpressionOverride"])


class NpcBlob(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 237.
    Blob
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0"):
...
class NpcBreen(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2192.
    Dr Breen
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, model: str="models/breen.mdl", spawnflags=""):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "model", "spawnflags"])


class NpcBullseye(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 761.
    Bullseye
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", parentname: str="", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", health: int=35, minangle: str="360", mindist: float="0", autoaimradius: float="0", spawnflags=""):
...
class NpcCitizen(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 886.
    Citizen
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, NumGrenades="0", SetGrenadeCapabilities="None", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", waitingtorappel="No", spawnflags="", additionalequipment="0", ammosupply="SMG1", ammoamount: int=1, citizentype="Default", expressiontype="Random", model="models/humans/group01/male_01.mdl", ExpressionOverride: str="", notifynavfailblocked=0, neverleaveplayersquad=0, denycommandconcept: str="", SetTossMedkits=0, AlternateAiming=0):
        ...
        # Toss medkits? : Episodic only. Griggs in Half-Life 2: Episode Two uses experimental code that allows him to toss medkits at the player from a distance. This activates that code on this NPC if it is a medic. Does not work with ammo resuppliers.
        self.SetTossMedkits = SetTossMedkits
        # Alternate aiming animations : Causes this citizen to use readiness aiming animations with a SMG, AR2, or shotgun. When running or walking while aiming/shooting, they will hold their weapon around their upper-chest instead of from their hip.
        self.AlternateAiming = AlternateAiming

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "NumGrenades", "SetGrenadeCapabilities", "AlwaysTransition", "DontPickupWeapons", "GameEndAlly", "waitingtorappel", "spawnflags", "additionalequipment", "ammosupply", "ammoamount", "citizentype", "expressiontype", "model", "ExpressionOverride", "notifynavfailblocked", "neverleaveplayersquad", "denycommandconcept", "SetTossMedkits", "AlternateAiming"])


class NpcClawscanner(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1966.
    Claw Scanner
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", spawnflags="", CustomFlightSpeed: float="0", spotlightlength: int=500, spotlightwidth: int=50, spotlightdisabled=0, ShouldInspect=1, OnlyInspectPlayers=0, NeverInspectPlayers=0, DisablePhotos=0):
        ...
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Custom Flight Speed : Overrides the scanner's default speed. 0 = use default
        self.CustomFlightSpeed: float = CustomFlightSpeed
        # Spotlight Length : 
        ...
        # Never take photos : Prevents this scanner from ever taking photos. It may still chase and inspect, but it will never actually take any pictures or flashes.
        self.DisablePhotos = DisablePhotos


        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "spawnflags", "CustomFlightSpeed", "spotlightlength", "spotlightwidth", "spotlightdisabled", "ShouldInspect", "OnlyInspectPlayers", "NeverInspectPlayers", "DisablePhotos"])


class NpcCombineCamera(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 256.
...
class NpcCombineCannon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 251.
    Combine Cannon
    """
...
class NpcCombineS(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1126.
    Combine Soldier
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", waitingtorappel="No", additionalequipment="weapon_smg1", spawnflags="", NumGrenades="5", UnderthrowGrenades="0", SetAlternateCapable="0", model="models/combine_soldier.mdl", tacticalvariant="0", usemarch="0"):
        ...
        # Number of Grenades : 
        self.NumGrenades = NumGrenades
        # Underthrow Grenades : If enabled, this soldier will 'underthrow' their grenades with ACT_SPECIAL_ATTACK1, which looks a lot more like the HL1 grunt animation. This includes grenades thrown during regular behavior and grenades forced with ThrowGrenadeAtTarget.
        self.UnderthrowGrenades = UnderthrowGrenades
        # Alternate Capable : Makes the soldier capable of using both grenades AND energy balls at the same time, regardless of their elite status.
        self.SetAlternateCapable = SetAlternateCapable

        # Model : Sets this soldier's model.
        self.model = model
        # Tactical Variant : 
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "waitingtorappel", "additionalequipment", "spawnflags", "NumGrenades", "UnderthrowGrenades", "SetAlternateCapable", "model", "tacticalvariant", "usemarch"])


class NpcCombinedropship(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1615.
    Combine Dropship
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", InitialSpeed: str="0", target: str="", spawnflags="", LandTarget: str="", GunRange: float=2048, RollermineTemplate: str="", NPCTemplate: str="", NPCTemplate2: str="", NPCTemplate3: str="", NPCTemplate4: str="", NPCTemplate5: str="", NPCTemplate6: str="", Dustoff1: str="", Dustoff2: str="", Dustoff3: str="", Dustoff4: str="", Dustoff5: str="", Dustoff6: str="", APCVehicleName: str="", Invulnerable=0, DontEmitDanger=0, CrateType=2, AllowsAnyDamage=0):
        ...
        # Don't emit danger on dropoff : Prevents this dropship from emitting danger sounds when it's dropping off soldiers.
        self.DontEmitDanger = DontEmitDanger
        # Crate Type : 
        self.CrateType = CrateType
        # Allows any damage (to container) : Allows this dropship's container (if it's a soldier crate) to take any amount of any type of damage, including bullet or melee damage. This is supposed to allow dropship containers to be taken down in previously impossible ways and should be used with an actual damage filter.
        self.AllowsAnyDamage = AllowsAnyDamage

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "InitialSpeed", "target", "spawnflags", "LandTarget", "GunRange", "RollermineTemplate", "NPCTemplate", "NPCTemplate2", "NPCTemplate3", "NPCTemplate4", "NPCTemplate5", "NPCTemplate6", "Dustoff1", "Dustoff2", "Dustoff3", "Dustoff4", "Dustoff5", "Dustoff6", "APCVehicleName", "Invulnerable", "DontEmitDanger", "CrateType", "AllowsAnyDamage"])


class NpcCombinegunship(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1561.
    Combine Gunship
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", InitialSpeed: str="0", target: str="", HealthIncrements: int=0, CanGroundAttack=0, spawnflags=""):
        ...
        # Health Increments : The number of times this gunship must be damaged before dying. This value is multiplied by 0.5 on Easy and 1.5 on Hard. 0 = the value stored in sk_gunship_health_increments (default 5).
        self.HealthIncrements: int = HealthIncrements
        # Can use ground attack automatically : Allows this gunship to use its belly cannon automatically during combat.
        self.CanGroundAttack = CanGroundAttack
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "InitialSpeed", "target", "HealthIncrements", "CanGroundAttack", "spawnflags"])


class NpcCrabsynth(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2059.
    Crab Synth
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0"):
...
class NpcCranedriver(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 402.
...
class NpcCrow(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 691.
    Crow
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", deaf=0):
...
class NpcCscanner(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1899.
    City Scanner
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", spawnflags="", CustomFlightSpeed: float="0", spotlightlength: int=500, spotlightwidth: int=50, spotlightdisabled=0, ShouldInspect=1, OnlyInspectPlayers=0, NeverInspectPlayers=0, DisablePhotos=0):
...
class NpcDog(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2210.
    d0g
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0"):
...
class NpcEli(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2182.
    Eli Vance
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, parentname: str="", model: str="models/eli.mdl"):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "parentname", "model"])


class NpcEnemyfinder(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 785.
    EnemyFinder
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", parentname: str="", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", spawnflags="", FieldOfView: float="0.2", MinSearchDist: int=0, MaxSearchDist: int=2048, freepass_timetotrigger: float=0, freepass_duration: float=0, freepass_movetolerance: float=120, freepass_refillrate: float="0.5", freepass_peektime: float=0, StartOn=1, SetClassify=0):
        ...
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # FieldOfView : The enemy finder's viewcone. (1.0 = straight ahead, 0.0 = +/- 90 degrees, -1.0 = all directions)
        ...
        # Classify : Allows this npc_enemyfinder to simulate a NPC's Class_T. Useful for relationships.
        self.SetClassify = SetClassify
...
class NpcEnemyfinderCombinecannon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 848.
...
class NpcFastzombie(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1825.
    Fast Zombie
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags=""):
        ...
        # Headcrab-less : Toggles whether this zombie should have a headcrab on their head. They usually should.
        self.Headless = Headless
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags


        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Headless", "spawnflags"])


class NpcFastzombieTorso(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1830.
    Fast Zombie Torso
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags=""):
...
class NpcFisherman(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1048.
    Fisherman
    """
...
class NpcGman(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2206.
    The G-Man
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore"])


class NpcGrenadeFrag(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 245.
    Hand Grenade
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str=""):
...
class NpcHeadcrab(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 728.
    Headcrab
    """
...
class NpcHeadcrabBlack(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 734.
    Black Headcrab
    """
...
class NpcHeadcrabFast(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 731.
    Fast Headcrab
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", startburrowed="No", spawnflags=""):
...
class NpcHeliAvoidbox(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1795.
...
class NpcHeliAvoidsphere(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1786.
...
class NpcHeliNobomb(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1803.
...
class NpcHelicopter(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1697.
    Helicopter
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", target: str="", skin: int=0, modelscale: float="1.0", disableshadows=0, model: str="models/combine_helicopter.mdl", health: int=0, spawnflags="", InitialSpeed: str="0", GracePeriod: float="2.0", PatrolSpeed: float="0", FieldOfView: float="-1.0", noncombat="No"):
        ...
        # World Model : This model should have the right attachments.
        self.model: str = model
        # Health : Overrides this helicopter's health. 0 = default npc_helicopter health (5600).
        self.health: int = health
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Initial Speed : 
        ...
        # Field of View : The helicoter's viewcone. (1.0 = straight ahead, 0.0 = +/- 90 degrees, -1.0 = all directions)
        self.FieldOfView: float = FieldOfView
        # Non-combat (Do not precache gibs) : If enabled, this helicopter will not precache stuff that would only be seen in combat, like mines or gibs. Even damaging the helicopter in this state can crash the game, so you might want to use a damage filter too.
        self.noncombat = noncombat

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "target", "skin", "modelscale", "disableshadows", "model", "health", "spawnflags", "InitialSpeed", "GracePeriod", "PatrolSpeed", "FieldOfView", "noncombat"])


class NpcHunter(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1219.
...
class NpcHunterMaker(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1250.
...
class NpcIchthyosaur(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 703.
...
class NpcKleiner(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2177.
    Kleiner
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, model: str="models/kleiner.mdl"):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "model"])


class NpcLauncher(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1156.
    Launcher
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", parentname: str="", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", spawnflags="", StartOn=0, OwnerEntity: str="", MissileModel: str="models/weapons/w_missile.mdl", LaunchSound: str="npc/waste_scanner/grenade_fire.wav", FlySound: str="Missile.Accelerate", SmokeTrail=1, LaunchSmoke=1, LaunchDelay: int=8, LaunchSpeed: str=200, PathCornerName: str="", HomingSpeed: str=0, HomingStrength: int=10, HomingDelay: str=0, HomingRampUp: str="0.5", HomingDuration: str=5, HomingRampDown: str="1.0", Gravity: str="1.0", MinRange: int=100, MaxRange: int=2048, SpinMagnitude: str=0, SpinSpeed: str=0, Damage: str=50, DamageRadius: str=200):
        ...
        # Start On : 
        self.StartOn = StartOn
        # Owner Entity : The entity that should 'own' the missiles, or receive credit/not collide with them.
        self.OwnerEntity: str = OwnerEntity
        # Missile Model : 
        ...
        self.auto_properties.extend(["origin", "parentname", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "spawnflags", "StartOn", "OwnerEntity", "MissileModel", "LaunchSound", "FlySound", "SmokeTrail", "LaunchSmoke", "LaunchDelay", "LaunchSpeed", "PathCornerName", "HomingSpeed", "HomingStrength", "HomingDelay", "HomingRampUp", "HomingDuration", "HomingRampDown", "Gravity", "MinRange", "MaxRange", "SpinMagnitude", "SpinSpeed", "Damage", "DamageRadius"])


class NpcMagnusson(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2187.
    Magnusson
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, model: str="models/magnusson.mdl"):
...
class NpcMaker(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2291.
    NPC Maker
    """
...
class NpcManhack(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1972.
    Manhack
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Hacked="No", spawnflags="", ignoreclipbrushes="0"):
        ...
        # Start Hacked : Makes this NPC start as if Alyx had hacked it. This causes the NPC to switch sides and might give it a different color.
        self.Hacked = Hacked
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Hacked", "spawnflags", "ignoreclipbrushes"])


class NpcMetropolice(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1997.
    MetroPolice
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", waitingtorappel="No", NumGrenades="0", model: str="models/police.mdl", additionalequipment="weapon_pistol", manhacks=0, weapondrawn=0, spawnflags=""):
        ...
        # Model : The model of this npc_metropolice. Keep in mind this overrides the 'Efficient' spawnflag which sets the model to police_cheaple.mdl.
        self.model: str = model
        # Weapons : 
        self.additionalequipment = additionalequipment
        # Number of Manhacks : 
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "waitingtorappel", "NumGrenades", "model", "additionalequipment", "manhacks", "weapondrawn", "spawnflags"])


class NpcMissiledefense(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 466.
    Missile Defense
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0"):
...
class NpcMonk(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2063.
    Monk
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, additionalequipment="weapon_annabelle", HasGun=1):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "additionalequipment", "HasGun"])


class NpcMortarsynth(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1992.
    Mortar Synth
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0"):
...
class NpcMossman(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2202.
    Dr Mossman
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0):
...
class NpcPigeon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 699.
    Pigeon
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", deaf=0):
...
class NpcPoisonzombie(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1888.
    A bloated, disgusting, fluid-spurting zombie created by a poison headcrab.
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags="", crabcount=3):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Headless", "spawnflags", "crabcount"])


class NpcRollermine(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 439.
    Roller Mine
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Hacked="No", spawnflags="", startburied="No", uniformsightdist=0):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Hacked", "spawnflags", "startburied", "uniformsightdist"])


class NpcSeagull(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 695.
    Seagull
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", deaf=0):
...
class NpcSniper(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 470.
    Sniper
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", model: str="models/combine_soldier.mdl", radius: int=0, misses: int=0, beambrightness: int=100, shootZombiesInChest=0, BeamName: str="effects/bluelaser1.vmt", BeamColor: "RGB"="0 100 255", PaintInterval: float=1, PaintIntervalVariance: float="0.75", spawnflags=""):
        ...
        # Model : The model of this sniper. Can be seen when the sniper dies.
        self.model: str = model
        ...
        # Beam Texture : The texture that should be used by the sniper's laser beam. Be sure to put '.vmt' at the end!
        self.BeamName: str = BeamName
        # Beam Color : The color that should be used by the sniper's laser beam.
        self.BeamColor: "RGB" = BeamColor
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "model", "radius", "misses", "beambrightness", "shootZombiesInChest", "BeamName", "BeamColor", "PaintInterval", "PaintIntervalVariance", "spawnflags"])


class NpcStalker(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 738.
    Stalker
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", BeamPower="Low", Aggression=0, Bleed=1):
        ...
        # Start Aggressive : Controls whether this stalker starts aggressive to the player and their allies without having to be provoked first.
        self.Aggression = Aggression
        # Bleed : Allows this stalker to bleed upon taking bleedable damage. They bleed saline.
        self.Bleed = Bleed

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "BeamPower", "Aggression", "Bleed"])


class NpcStrider(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1464.
    Strider
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", model="models/combine_strider.mdl", stompfilter: str="", spawnflags="", disablephysics=0):
        ...
        self.model = model
        # Stomp Filter : Which entities am I allowed to stomp? Don't forget to use the 'Can Stomp Player' spawnflag as well.
        self.stompfilter: str = stompfilter
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Disable physics (reduce CPU) : 
        self.disablephysics = disablephysics

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "model", "stompfilter", "spawnflags", "disablephysics"])


class NpcTripmine(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4285.
    S.L.A.M. Tripmine
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", PowerUpTime: float="2.0", Damage: float="150", DmgRadius: float="200", spawnflags=""):
        Entity.__init__(self, "npc_tripmine", vmf_map)
        ...
        # Power Up Time : How much time this tripmine takes to power up after being activated.
        self.PowerUpTime: float = PowerUpTime
        # Damage : The amount of damage this tripmine can deal.
        self.Damage: float = Damage
        # Damage Radius : The radius in which this tripmine can damage.
        self.DmgRadius: float = DmgRadius
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "PowerUpTime", "Damage", "DmgRadius", "spawnflags"])


class NpcTurretCeiling(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 294.
    Combine Ceiling Turret
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", model: str="", skin: int=0, modelscale: float="1.0", disableshadows=0, spawnflags="", minhealthdmg: int=0, health: int=100, FieldOfView: float="0.0"):
        ...
        self.minhealthdmg: int = minhealthdmg
        # Health : Health was 1000 in the original Half-Life 2.
        self.health: int = health
        # FieldOfView : The ceiling turret's viewcone. (1.0 = straight ahead, 0.0 = +/- 90 degrees, -1.0 = all directions)
        self.FieldOfView: float = FieldOfView

        self.auto_properties.extend(["origin", "targetname", "angles", "model", "skin", "modelscale", "disableshadows", "spawnflags", "minhealthdmg", "health", "FieldOfView"])


class NpcTurretFloor(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 344.
    Combine Floor Turret
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", Hacked="No", spawnflags="", skin: int=0):
        ...
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Skin Number : Which skin to use for this turret. If a citizen turret, set to 0 to select randomly.
        self.skin: int = skin

        self.auto_properties.extend(["origin", "targetname", "angles", "Hacked", "spawnflags", "skin"])


class NpcTurretGround(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 286.
...
class NpcTurretLab(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 326.
    Eli's Lab Turret
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", model: str="", skin: int=0, modelscale: float="1.0", disableshadows=0, spawnflags="", minhealthdmg: int=0, health: int=100, FieldOfView: float="-0.5", ManualArmYaw="No", Mirrored="No"):
        Entity.__init__(self, "npc_turret_lab", vmf_map)
        ...
        # FieldOfView : The ceiling turret's viewcone. (1.0 = straight ahead, 0.0 = +/- 90 degrees, -1.0 = all directions)
        self.FieldOfView: float = FieldOfView
        # Static Arm : Prevents the arm from moving.
        self.ManualArmYaw = ManualArmYaw
        # Mirrored : 'Mirrors' the turret, which changes certain animations.
        self.Mirrored = Mirrored

        self.auto_properties.extend(["origin", "targetname", "angles", "model", "skin", "modelscale", "disableshadows", "spawnflags", "minhealthdmg", "health", "FieldOfView", "ManualArmYaw", "Mirrored"])


class NpcVehicledriver(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 390.
...
class NpcVortigaunt(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1394.
    Vortigaunt
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", DontUseSpeechSemaphore=0, NumGrenades="0", SetGrenadeCapabilities="None", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", model: str="models/vortigaunt.mdl", ArmorRechargeEnabled=1, HealthRegenerateEnabled=0):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "spawnflags", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "DontUseSpeechSemaphore", "NumGrenades", "SetGrenadeCapabilities", "AlwaysTransition", "DontPickupWeapons", "GameEndAlly", "model", "ArmorRechargeEnabled", "HealthRegenerateEnabled"])


class NpcZombie(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1835.
    Zombie
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags=""):
...
class NpcZombieCustom(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1845.
    Custom Zombie
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags="", skin: int=0, modelscale: float="1.0", disableshadows=0, health: int=0, model: str="models/Zombie/Classic.mdl", LegsModel: str="models/zombie/classic_legs.mdl", TorsoModel: str="models/zombie/classic_torso.mdl", HeadcrabClassname: str="npc_headcrab", HeadcrabModel: str="models/headcrabclassic.mdl"):
        Entity.__init__(self, "npc_zombie_custom", vmf_map)
        ...
        # Health : Overrides this zombie's health. 0 = default npc_zombie health.
        self.health: int = health
        # Model : The zombie's model.
        self.model: str = model
        # Legs Model : The model to use for legs. You can leave this blank if you enable the 'No Torso' spawnflag.
        self.LegsModel: str = LegsModel
        # Torso Model : The model to use for torso. You can leave this blank if you enable the 'No Torso' spawnflag.
        self.TorsoModel: str = TorsoModel
        # Headcrab Classname : The NPC that should be used as the 'headcrab'. You can leave this blank if the zombie is marked as headcrab-less.
        self.HeadcrabClassname: str = HeadcrabClassname
        # Headcrab Model : The model that should be used for 'headcrab' ragdolls. You can leave this blank if the zombie is marked as headcrab-less.
        self.HeadcrabModel: str = HeadcrabModel

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Headless", "spawnflags", "skin", "modelscale", "disableshadows", "health", "model", "LegsModel", "TorsoModel", "HeadcrabClassname", "HeadcrabModel"])


class NpcZombieCustomTorso(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1857.
    Custom Zombie Torso
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags="", skin: int=0, modelscale: float="1.0", disableshadows=0, health: int=0, model: str="models/Zombie/Classic_torso.mdl", HeadcrabClassname: str="npc_headcrab", HeadcrabModel: str="models/headcrabclassic.mdl"):
        Entity.__init__(self, "npc_zombie_custom_torso", vmf_map)
...
class NpcZombieTorso(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1839.
    Zombie Torso
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags=""):
...
class NpcZombine(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 1868.
    Combine Soldier Zombie
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, damagefilter: str="", ResponseContext: str="", disableshadows=0, target: str="", squadname: str="", hintgroup: str="", hintlimiting=0, sleepstate=0, wakeradius: float=0, wakesquad=0, enemyfilter: str="", ignoreunseenenemies=0, physdamagescale: float="1.0", Headless="No", spawnflags="", NumGrenades="1"):
        ...
        # Number of Grenades : The number of grenades this zombine can pull out.
        self.NumGrenades = NumGrenades

        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "damagefilter", "ResponseContext", "disableshadows", "target", "squadname", "hintgroup", "hintlimiting", "sleepstate", "wakeradius", "wakesquad", "enemyfilter", "ignoreunseenenemies", "physdamagescale", "Headless", "spawnflags", "NumGrenades"])


class PathCorner(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4393.
    Generic path point
    """
...
class PathCornerCrash(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4412.
...
class PlayerLoadsaved(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4424.
...
class PlayerSpeedmod(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4444.
    Speeds up or slows down player velocity over time (slow mo/fast forward)
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", spawnflags="", AdditionalButtons: int=0):
        ...
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Additional Buttons : Additional buttons to suppress, other than those listed in the spawnflags. Advanced users only.
        self.AdditionalButtons: int = AdditionalButtons

        self.auto_properties.extend(["origin", "targetname", "spawnflags", "AdditionalButtons"])


class PlayerWeaponstrip(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4437.
...
class PointAntlionRepellant(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2369.
    Antlion Repellant
    """
...
class PointApcController(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5104.
    APC Controller
    """
...
class PointBugbait(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4366.
    Bugbait sensor point
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", Enabled=1, spawnflags="", radius: int=512):
        ...
        self.auto_properties.extend(["origin", "targetname", "parentname", "Enabled", "spawnflags", "radius"])


class PointCamera(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4954.
    Camera
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", spawnflags="", FOV: float=90, UseScreenAspectRatio=0, fogEnable=0, fogColor: "RGB"="0 0 0", fogStart: float=2048, fogEnd: float=4096, fogMaxDensity: float=1, SkyMode=2):
        ...
        # Sky Mode : How to draw the sky through this point_camera.
        self.SkyMode = SkyMode

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "spawnflags", "FOV", "UseScreenAspectRatio", "fogEnable", "fogColor", "fogStart", "fogEnd", "fogMaxDensity", "SkyMode"])


class PointCameraOrtho(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4995.
    Orthographic Camera
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", angles: "Origin"="0 0 0", spawnflags="", FOV: float=90, UseScreenAspectRatio=0, fogEnable=0, fogColor: "RGB"="0 0 0", fogStart: float=2048, fogEnd: float=4096, fogMaxDensity: float=1, SkyMode=2, Ortho0: float=100, Ortho1: float=0, Ortho2: float=0, Ortho3: float=0, IsOrtho=1):
        Entity.__init__(self, "point_camera_ortho", vmf_map)
        ...
        # Ortho Top : The ortho's top dimension. Will be FOV if 0.
        self.Ortho0: float = Ortho0
        # Ortho Bottom : The ortho's bottom dimension. Will be a negative version of the top if 0.
        self.Ortho1: float = Ortho1
        # Ortho Left : The ortho's left dimension. Will be the top if 0.
        self.Ortho2: float = Ortho2
        # Ortho Right : The ortho's right dimension. Will be a negative version of the left if 0.
        self.Ortho3: float = Ortho3
        # Ortho Enabled : Sets whether this camera is orthographic. This is for when you want to toggle ortho mode via input.
        self.IsOrtho = IsOrtho

        self.auto_properties.extend(["origin", "targetname", "parentname", "angles", "spawnflags", "FOV", "UseScreenAspectRatio", "fogEnable", "fogColor", "fogStart", "fogEnd", "fogMaxDensity", "SkyMode", "Ortho0", "Ortho1", "Ortho2", "Ortho3", "IsOrtho"])


class PointCombineBallLauncher(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 220.
    Launches Combine balls.
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", origin: "Origin"="", angles: "Origin"="0 0 0", globalname: str="", ballcount: int=3, minspeed: float="300.0", maxspeed: float="600.0", ballradius: float="20.0", balltype="Combine Energy Ball 1", ballrespawntime: float="4.0f", parentname: str="", launchconenoise: float="0.0", bullseyename: str="", maxballbounces: int=8, spawnflags=""):
        ...
        self.auto_properties.extend(["targetname", "origin", "angles", "globalname", "ballcount", "minspeed", "maxspeed", "ballradius", "balltype", "ballrespawntime", "parentname", "launchconenoise", "bullseyename", "maxballbounces", "spawnflags"])


class PointFleshEffectTarget(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5571.
    Flesh Effect Target
    """
...
class PointPush(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5510.
    Point Push
    """
...
class PointRadiationSource(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3688.
    Radiation source that trips the player's geiger counter. Does no actual damage.
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", StartDisabled=0, SetRadius: float="0", SetIntensity: float="1.0", TestPVS=1):
        Entity.__init__(self, "point_radiation_source", vmf_map)
        ...
        # Radius : Only affects the geiger counter if the player is within this radius. 0 = no radius, use intensity only
        self.SetRadius: float = SetRadius
        # Intensity : The intensity of the radiation source. Cannot be 0.
        self.SetIntensity: float = SetIntensity
        # Test PVS : Tests whether the player is in this entity's PVS before attempting to update.
        self.TestPVS = TestPVS

        self.auto_properties.extend(["origin", "targetname", "parentname", "StartDisabled", "SetRadius", "SetIntensity", "TestPVS"])


class PropCombineBall(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 171.
...
class PropCoreball(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5482.
    Core Ball
    """
...
class PropFlare(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5496.
    Flare Prop
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", globalname: str="", skin: int=0, modelscale: float="1.0", disableshadows=0, ExplodeDamage: float=0, ExplodeRadius: float=0, PerformanceMode=0, BreakModelMessage: str="", pressuredelay: float=0, mindxlevel=0, maxdxlevel=0, spawnflags="", minhealthdmg: int=0, shadowcastdist: int=0, physdamagescale: float="0.1", Damagetype=0, nodamageforces=0, inertiaScale: float="1.0", massScale: float="0", overridescript: str="", damagetoenablemotion: int=0, forcetoenablemotion: float=0, puntsound: str="", targetname: str="", angles: "Origin"="0 0 0", damagefilter: str="", fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, model: str="models/props_junk/flare.mdl"):
        Entity.__init__(self, "prop_flare", vmf_map)
        ...
        # Model : Any model entered here can use flares.
        self.model: str = model

        self.auto_properties.extend(["origin", "globalname", "skin", "modelscale", "disableshadows", "ExplodeDamage", "ExplodeRadius", "PerformanceMode", "BreakModelMessage", "pressuredelay", "mindxlevel", "maxdxlevel", "spawnflags", "minhealthdmg", "shadowcastdist", "physdamagescale", "Damagetype", "nodamageforces", "inertiaScale", "massScale", "overridescript", "damagetoenablemotion", "forcetoenablemotion", "puntsound", "targetname", "angles", "damagefilter", "fademindist", "fademaxdist", "fadescale", "model"])


class PropScalable(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5489.
    Scalable Prop
    """
...
class PropThumper(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 560.
    Thumper
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", skin: int=0, modelscale: float="1.0", disableshadows=0, model: str="models/props_combine/CombineThumper002.mdl", dustscale="Small Thumper", EffectRadius: int=1000):
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "skin", "modelscale", "disableshadows", "model", "dustscale", "EffectRadius"])


class PropVehicle(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5085.
...
class PropVehicleAirboat(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5241.
...
class PropVehicleApc(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5130.
    APC with mounted guns, can only be driven by a vehicle driver or a npc_apcdriver.
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", origin: "Origin"="", globalname: str="", angles: "Origin"="0 0 0", mindxlevel=0, maxdxlevel=0, skin: int=0, solid=6, disableshadows=0, screenspacefade=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, lightingorigin: str="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx: int=32, lightmapresolutiony: int=32, vehiclescript: str="scripts/vehicles/jeep_test.txt", actionScale: float="1", model: str="models/combine_apc.mdl", VehicleLocked=1, missilehint: str=""):
        ...
        # World model : 
        self.model: str = model
        # Start locked : APCs cannot be properly controlled by players, at least not by default. It's best to keep this locked.
        self.VehicleLocked = VehicleLocked
        ...
        self.auto_properties.extend(["targetname", "origin", "globalname", "angles", "mindxlevel", "maxdxlevel", "skin", "solid", "disableshadows", "screenspacefade", "fademindist", "fademaxdist", "fadescale", "lightingorigin", "disablevertexlighting", "disableselfshadowing", "ignorenormals", "generatelightmaps", "lightmapresolutionx", "lightmapresolutiony", "vehiclescript", "actionScale", "model", "VehicleLocked", "missilehint"])


class PropVehicleCannon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5256.
...
class PropVehicleChoreoGeneric(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5424.
...
class PropVehicleCrane(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5262.
...
class PropVehicleDriveable(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5099.
...
class PropVehicleJeep(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5161.
    Driveable studiomodel jeep.
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", origin: "Origin"="", globalname: str="", angles: "Origin"="0 0 0", mindxlevel=0, maxdxlevel=0, skin: int=0, solid=6, disableshadows=0, screenspacefade=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, lightingorigin: str="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx: int=32, lightmapresolutiony: int=32, vehiclescript: str="scripts/vehicles/jeep_test.txt", actionScale: float="1", VehicleLocked=0, model: str="models/buggy.mdl", CargoVisible=0, NoHazardLights=0, spawnflags="", EnableGun=0):
        ...
        # World model : Use jalopy.mdl if you're using Episodic. If you want to use the original HL2 buggy in Episodic, use prop_vehicle_jeep_old.
        self.model: str = model
        # Hopper Visible : Is the striderbuster cargo hopper visible?
        self.CargoVisible = CargoVisible
        # No Hazard Lights : Stops the jalopy's hazard lights from turning on and flashing when the player exits the vehicle.
        self.NoHazardLights = NoHazardLights
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Has Gun : Whether the jeep's tau cannon is enabled or disabled.
        self.EnableGun = EnableGun

        self.auto_properties.extend(["targetname", "origin", "globalname", "angles", "mindxlevel", "maxdxlevel", "skin", "solid", "disableshadows", "screenspacefade", "fademindist", "fademaxdist", "fadescale", "lightingorigin", "disablevertexlighting", "disableselfshadowing", "ignorenormals", "generatelightmaps", "lightmapresolutionx", "lightmapresolutiony", "vehiclescript", "actionScale", "VehicleLocked", "model", "CargoVisible", "NoHazardLights", "spawnflags", "EnableGun"])


class PropVehicleJeepOld(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5222.
    A way to access the original HL2 jeep in Episodic. Just use prop_vehicle_jeep if you're using the original HL2 version.
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", origin: "Origin"="", globalname: str="", angles: "Origin"="0 0 0", mindxlevel=0, maxdxlevel=0, skin: int=0, solid=6, disableshadows=0, screenspacefade=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1, lightingorigin: str="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx: int=32, lightmapresolutiony: int=32, vehiclescript: str="scripts/vehicles/jeep_test.txt", actionScale: float="1", VehicleLocked=0, model: str="models/buggy.mdl"):
        Entity.__init__(self, "prop_vehicle_jeep_old", vmf_map)
        ...
        self.auto_properties.extend(["targetname", "origin", "globalname", "angles", "mindxlevel", "maxdxlevel", "skin", "solid", "disableshadows", "screenspacefade", "fademindist", "fademaxdist", "fadescale", "lightingorigin", "disablevertexlighting", "disableselfshadowing", "ignorenormals", "generatelightmaps", "lightmapresolutionx", "lightmapresolutiony", "vehiclescript", "actionScale", "VehicleLocked", "model"])


class PropVehiclePrisonerPod(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5270.
...
class ScriptIntro(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5327.
    Script: Custom entity used to handle the intro sequence.
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", alternatefovchange=0, DrawSky=0, DrawSky2=0):
        ...
        # Draw skybox : Allows the skybox to be drawn while the script_intro is active. Drawing the skybox *might* break the VortWarp shader used by the transcending vortigaunts in EP1/EP2.
        self.DrawSky = DrawSky
        # Draw skybox in camera view : Allows the skybox to be drawn in the second view. Otherwise draws a solid white background.
        self.DrawSky2 = DrawSky2

        self.auto_properties.extend(["origin", "targetname", "alternatefovchange", "DrawSky", "DrawSky2"])


class ScriptTauremoval(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5318.
...
class ScriptedSentence(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2465.
    Scripted Sentence
    """
...
class ScriptedSequence(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3425.
    ...
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", parentname: str="", m_iszEntity: str="", m_iszIdle: str="", m_iszEntry: str="", m_iszPlay: str="", m_iszPostIdle: str="", m_iszCustomMove: str="", m_bLoopActionSequence=0, m_bSynchPostIdles=0, m_flRadius: int=0, m_flRepeat: int=0, m_fMoveTo=1, m_iszNextScript: str="", m_bIgnoreGravity=0, m_bDisableNPCCollisions=0, angles: "Origin"="0 0 0", mindxlevel=0, maxdxlevel=0, spawnflags="", onplayerdeath=0):
        ...
        # Post Action Idle Animation : The name of the sequence (such as 'idle01') or activity (such as 'ACT_IDLE') to play after the action animation. If the ''Loop in Post Idle'' spawnflag is not ticked, this will act as an Exit Animation, similar to the Entry Animation.
        ...
        # Loop Action Animation? : Loops the action animation until the sequence is cancelled or interrupted.
        self.m_bLoopActionSequence = m_bLoopActionSequence
        # Synch Post Idles? : Causes scripts with the same targetname to immediately play their Post Action Idle Animation when the NPC starts playing the Post Action Idle Animation.
...
class ScriptedSound(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2525.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", message: str="", target: str="", GrabAll=0):
        Entity.__init__(self, "scripted_sound", vmf_map)
        ...
        # Sound Name : The sound to play. Supports Game Sounds and direct filenames.
        self.message: str = message
        # Target Entity : The entity that should play the sound.
        self.target: str = target
        # Grab All : Makes all entities play the sound instead of just one.
        self.GrabAll = GrabAll

        self.auto_properties.extend(["origin", "targetname", "message", "target", "GrabAll"])


class ScriptedTarget(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 2499.
    Scripted Target
    """
...
class TestSidelist(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5403.
    Test entity for Ken!
    """
...
class TriggerPhysicsTrap(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 179.
...
class TriggerRpgfire(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4304.
...
class TriggerVphysicsMotion(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4311.
...
class TriggerWaterydeath(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 3593.
    ...
    """
    def __init__(self, vmf_map: "ValveMap", targetname: str="", parentname: str="", origin: "Origin"="", StartDisabled=0, globalname: str="", spawnflags="", filtername: str="", BiteInterval: float="0.3", PainStep: float="2.0", MaxPain: float="15.0"):
        ...
        # Bite Interval : The amount of time that should pass in between leech bites.
        self.BiteInterval: float = BiteInterval
        # Pain Step : Damage will increase by this number for each leech bite.
        self.PainStep: float = PainStep
        # Max Pain : This is the maximum damage that could be attained after multiple pain steps.
        self.MaxPain: float = MaxPain

        self.auto_properties.extend(["targetname", "parentname", "origin", "StartDisabled", "globalname", "spawnflags", "filtername", "BiteInterval", "PainStep", "MaxPain"])


class TriggerWeaponDissolve(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 190.
...
class TriggerWeaponStrip(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 203.
...
class VehicleViewcontroller(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5234.
...
class Weapon357(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4275.
    357
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
        ...
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
        # Ammo 1 Override : Overrides the amount of primary ammo this weapon has. Be sure to set 'Preserve ammo values when picked up' for this to be maintained upon pickup.
        self.SetAmmo1: int = SetAmmo1
        # Ammo 2 Override : Overrides the amount of secondary ammo this weapon has. Be sure to set 'Preserve ammo values when picked up' for this to be maintained upon pickup.
        self.SetAmmo2: int = SetAmmo2
        # Start Fade Dist/Pixels : Distance at which the prop starts to fade (<0 = use fademaxdist). If 'Screen Space Fade' is selected, this represents the number of pixels wide covered by the prop when it starts to fade.
        self.fademindist: float = fademindist
        # End Fade Dist/Pixels : Maximum distance at which the prop is visible (0 = don't fade out). If 'Screen Space Fade' is selected, this represents the *minimum* number of pixels wide covered by the prop when it fades.
        self.fademaxdist: float = fademaxdist
        ...
        self.auto_properties.extend(["origin", "targetname", "angles", "renderfx", "rendermode", "renderamt", "rendercolor", "disablereceiveshadows", "spawnflags", "SetAmmo1", "SetAmmo2", "fademindist", "fademaxdist", "fadescale"])


class WeaponAlyxgun(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4281.
    Alyx Gun
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponAnnabelle(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4282.
    Annabelle (Grigori)
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponAr2(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4272.
    Assault Rifle 2
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponBugbait(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4280.
    Bug bait
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponCrossbow(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4276.
    Crossbow
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponCrowbar(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4269.
    Crowbar
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponFrag(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4278.
    Frag Grenade
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponPhyscannon(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4279.
    Physics Cannon
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponPistol(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4271.
    Pistol
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponRpg(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4273.
    Missile Launcher
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponShotgun(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4277.
    Shotgun
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponSlam(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4283.
    A tripmine/satchel hybrid from HL2:MP.\n\nCome on and slam, and welcome to the jam!\nCome on and slam, if you wanna jam!
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponSmg1(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4274.
    SMG1
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
...
class WeaponStriderbuster(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 5551.
    Strider Buster
    """
...
class WeaponStunstick(Entity):
    """
    Auto-generated from mapbase_halflife2.fgd, line 4270.
    StunStick
    """
    def __init__(self, vmf_map: "ValveMap", origin: "Origin"="0 0 0", targetname: str="", angles: "Origin"="0 0 0", renderfx=0, rendermode=0, renderamt: int=255, rendercolor: "RGB"="255 255 255", disablereceiveshadows=0, spawnflags="", SetAmmo1: int=0, SetAmmo2: int=0, fademindist: float=-1, fademaxdist: float=0, fadescale: float=1):
