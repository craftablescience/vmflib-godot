...
This file was auto-generated by import_fgd.py on 2018-06-20 16:16:59.379379.
"""
...
class DispenserTouchTrigger(Entity):
    ...
    """
    def __init__(self, vmf_map, parentname="", targetname=""):
...
class FilterActivatorTfteam(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", TeamNum=0, targetname="", Negated="Allow entities that match criteria", controlpoint=""):
...
class FilterTfPlayerCanCap(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", TeamNum=0, targetname="", Negated="Allow entities that match criteria"):
...
class FuncCapturezone(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", StartDisabled=0, TeamNum=0, capturepoint=1):
...
class FuncChangeclass(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", TeamNum=0, StartDisabled=0):
...
class FuncFlagAlert(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", TeamNum=0, StartDisabled=0, playsound=1, alert_delay=10):
...
class FuncRegenerate(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", TeamNum=0, StartDisabled=0, associatedmodel=""):
...
class FuncRespawnflag(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", StartDisabled=0):
...
class FuncRespawnroomvisualizer(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", InputFilter=0, StartDisabled=0, disableshadows=0, spawnflags="", respawnroomname="", Solidity=1, vrad_brush_cast_shadows=0, solid_to_enemies=1):
        ...
        self.respawnroomname = respawnroomname
...
class GameIntroViewpoint(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", angles="0 0 0", TeamNum=0, step_number=1, time_delay=12, hint_message="", event_to_fire="", event_delay=3, event_data_int=0, fov=0):
        ...
        # Game Event To Fire : 
        self.event_to_fire = event_to_fire
        # Game Event fire delay : 
        self.event_delay = event_delay
        # Game Event data : 
        self.event_data_int = event_data_int
        # FOV : 
        self.fov = fov
...
class GameRoundWin(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, force_map_reset=1, switch_teams=0):
...
class GameTextTf(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", message="", icon="", display_to_team=0, background=0):
...
class InfoObserverPoint(Entity):
    ...
    Observer Point
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, angles="0 0 0", StartDisabled=0, associated_team_entity="", defaultwelcome=0, fov=0):
        ...
        self.associated_team_entity = associated_team_entity
...
class InfoPlayerTeamspawn(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, StartDisabled=0, angles="0 0 0", controlpoint="", round_bluespawn="", round_redspawn=""):
...
class ItemAmmopackFull(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, StartDisabled=0, angles="0 0 0", powerup_model=""):
        ...
        self.powerup_model = powerup_model
...
class ItemTeamflag(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", GameType=0, TeamNum=0, StartDisabled=0, angles="0 0 0", ReturnTime=60, NeutralType=1, ScoringType=0, flag_model="models/flag/briefcase.mdl", trail_effect=1):
...
class MapobjCartDispenser(Entity):
    ...
    TF2 Dispenser
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", TeamNum=2, spawnflags="", touch_trigger=""):
...
class ObjDispenser(Entity):
    ...
    TF2 Dispenser
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", TeamNum=2, spawnflags="", angles="0 0 0"):
...
class ObjSentrygun(Entity):
    ...
    TF2 Sentrygun
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", TeamNum=2, angles="0 0 0", defaultupgrade=0, spawnflags=""):
...
class TeamControlPoint(Entity):
    ...
    Control Point
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, angles="0 0 0", parentname="", spawnflags="", point_start_locked=0, point_printname="TODO", point_group=0, point_default_owner=0, point_index=0, point_warn_on_cap=0, point_warn_sound="ControlPoint.CaptureWarn", random_owner_on_restart=0, team_timedpoints_2=0, team_timedpoints_3=0, team_capsound_0="", team_capsound_2="", team_capsound_3="", team_model_0="models/effects/cappoint_hologram.mdl", team_model_2="models/effects/cappoint_hologram.mdl", team_model_3="models/effects/cappoint_hologram.mdl", team_bodygroup_0=3, team_bodygroup_2=1, team_bodygroup_3=1, team_icon_0="sprites/obj_icons/icon_obj_neutral", team_icon_2="sprites/obj_icons/icon_obj_red", team_icon_3="sprites/obj_icons/icon_obj_blu", team_overlay_0="", team_overlay_2="", team_overlay_3="", team_previouspoint_2_0="", team_previouspoint_2_1="", team_previouspoint_2_2="", team_previouspoint_3_0="", team_previouspoint_3_1="", team_previouspoint_3_2=""):
        ...
        # Print Name : 
        self.point_printname = point_printname
        ...
        self.point_warn_sound = point_warn_sound
        ...
        self.team_previouspoint_2_0 = team_previouspoint_2_0
        ...
        self.team_previouspoint_2_1 = team_previouspoint_2_1
        ...
        self.team_previouspoint_2_2 = team_previouspoint_2_2
        ...
        self.team_previouspoint_3_0 = team_previouspoint_3_0
        ...
        self.team_previouspoint_3_1 = team_previouspoint_3_1
        ...
        self.team_previouspoint_3_2 = team_previouspoint_3_2
...
class TeamControlPointMaster(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, team_base_icon_2="sprites/obj_icons/icon_base_red", team_base_icon_3="sprites/obj_icons/icon_base_blu", caplayout="", cpm_restrict_team_cap_win=0, switch_teams=0, score_style=0, play_all_rounds=0, partial_cap_points_rate=0):
        ...
        self.team_base_icon_2 = team_base_icon_2
        # Material for the BLUE Base icon : 
        self.team_base_icon_3 = team_base_icon_3
        ...
        self.partial_cap_points_rate = partial_cap_points_rate
...
class TeamControlPointRound(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, cpr_printname="", cpr_priority=0, cpr_cp_names="", cpr_restrict_team_cap_win=0):
        ...
        self.cpr_printname = cpr_printname
        ...
        self.cpr_priority = cpr_priority
        ...
        self.cpr_cp_names = cpr_cp_names
...
class TeamRoundTimer(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, timer_length=600, max_length=0, start_paused=1, setup_length=0, reset_time=0, auto_countdown=1, show_in_hud=1):
...
class TeamTrainWatcher(Entity):
    ...
    def __init__(self, vmf_map, origin="0 0 0", targetname="", TeamNum=0, StartDisabled=0, train_can_recede=1, train="", start_node="", goal_node="", linked_pathtrack_1="", linked_cp_1="", linked_pathtrack_2="", linked_cp_2="", linked_pathtrack_3="", linked_cp_3="", linked_pathtrack_4="", linked_cp_4="", linked_pathtrack_5="", linked_cp_5="", linked_pathtrack_6="", linked_cp_6="", linked_pathtrack_7="", linked_cp_7="", linked_pathtrack_8="", linked_cp_8="", hud_min_speed_level_1=30, hud_min_speed_level_2=60, hud_min_speed_level_3=90):
        ...
        # Linked PathTrack 1 : 
        self.linked_pathtrack_1 = linked_pathtrack_1
        # Linked CP 1 : 
        self.linked_cp_1 = linked_cp_1
        # Linked PathTrack 2 : 
        self.linked_pathtrack_2 = linked_pathtrack_2
        # Linked CP 2 : 
        self.linked_cp_2 = linked_cp_2
        # Linked PathTrack 3 : 
        self.linked_pathtrack_3 = linked_pathtrack_3
        # Linked CP 3 : 
        self.linked_cp_3 = linked_cp_3
        # Linked PathTrack 4 : 
        self.linked_pathtrack_4 = linked_pathtrack_4
        # Linked CP 4 : 
        self.linked_cp_4 = linked_cp_4
        # Linked PathTrack 5 : 
        self.linked_pathtrack_5 = linked_pathtrack_5
        # Linked CP 5 : 
        self.linked_cp_5 = linked_cp_5
        # Linked PathTrack 6 : 
        self.linked_pathtrack_6 = linked_pathtrack_6
        # Linked CP 6 : 
        self.linked_cp_6 = linked_cp_6
        # Linked PathTrack 7 : 
        self.linked_pathtrack_7 = linked_pathtrack_7
        # Linked CP 7 : 
        self.linked_cp_7 = linked_cp_7
        # Linked PathTrack 8 : 
        self.linked_pathtrack_8 = linked_pathtrack_8
        # Linked CP 8 : 
        self.linked_cp_8 = linked_cp_8
        # Min Speed for Speed Level 1 : 
        self.hud_min_speed_level_1 = hud_min_speed_level_1
        # Min Speed for Speed Level 2 : 
        self.hud_min_speed_level_2 = hud_min_speed_level_2
        # Min Speed for Speed Level 3 : 
        self.hud_min_speed_level_3 = hud_min_speed_level_3
...
class TfGamerules(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", hud_type=0, ctf_overtime=1):
...
class TfLogicArena(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, CapEnableDelay=0):
        ...
        self.CapEnableDelay = CapEnableDelay
...
class TfLogicKoth(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", timer_length=180, unlock_point=30):
        ...
        self.unlock_point = unlock_point
...
class TriggerCaptureArea(Entity):
    ...
    Capture Area
    """
    def __init__(self, vmf_map, targetname="", StartDisabled=0, parentname="", area_cap_point="", team_cancap_2=1, team_cancap_3=1, team_numcap_2=1, team_numcap_3=1, team_spawn_2=0, team_spawn_3=0, area_time_to_cap=5):
        ...
        self.team_spawn_2 = team_spawn_2
        ...
        self.team_spawn_3 = team_spawn_3
        # Time to cap (sec) : 
        self.area_time_to_cap = area_time_to_cap
