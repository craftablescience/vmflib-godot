...
This file was auto-generated by import_fgd.py on 2018-06-20 16:16:59.101123.
"""
...
class AiAllyManager(Entity):
    ...
    AI Ally Manager
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", maxallies=5, maxmedics=1):
        ...
        self.maxallies = maxallies
        # Maximum number of medics : 
        self.maxmedics = maxmedics
...
class AiBattleLine(Entity):
    ...
    Battle line
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", parentname="", spawnflags="", actor="", Active=0, Strict=1):
...
class AiChangehintgroup(Entity):
    ...
    Change Hint Group
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", SearchType=0, SearchName="", NewHintGroup="", Radius="0.0", hintlimiting=0):
        ...
        # New Hint Group : 
        self.NewHintGroup = NewHintGroup
...
class AiChangetarget(Entity):
    ...
    Change Target
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", target="", m_iszNewTarget=""):
        ...
        self.target = target
        # New Target : 
        self.m_iszNewTarget = m_iszNewTarget
...
class AiGoalActbusy(Entity):
    ...
    AI Goal Act Busy
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", StartActive=0, SearchType=0, busysearchrange=2048, visibleonly=0, seeentity="", seeentitytimeout="1", sightmethod=0, type=0, safezone="", allowteleport=0):
        ...
        self.busysearchrange = busysearchrange
        ...
        self.seeentitytimeout = seeentitytimeout
...
class AiGoalActbusyQueue(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", StartActive=0, SearchType=0, busysearchrange=2048, visibleonly=0, node_exit="", node01="", node02="", node03="", node04="", node05="", node06="", node07="", node08="", node09="", node10="", node11="", node12="", node13="", node14="", node15="", node16="", node17="", node18="", node19="", node20="", mustreachfront=0):
...
class AiGoalAssault(Entity):
    ...
    AI Goal Assault
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", rallypoint="", SearchType=0, StartActive=0, AssaultCue=1, RallySelectMethod=0):
...
class AiGoalFollow(Entity):
    ...
    AI Goal Follow
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", goal="", SearchType=0, StartActive=0, MaximumState=1, Formation=0):
...
class AiGoalLead(Entity):
    ...
    AI Goal Lead
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", goal="", WaitPointName="", WaitDistance="", LeadDistance="64", RetrieveDistance="96", SuccessDistance="0", Run="0", Retrieve=1, ComingBackWaitForSpeak=1, RetrieveWaitForSpeak=1, DontSpeakStart=0, LeadDuringCombat=0, GagLeader=0, AttractPlayerConceptModifier="", WaitOverConceptModifier="", ArrivalConceptModifier="", PostArrivalConceptModifier="", SuccessConceptModifier="", FailureConceptModifier="", ComingBackConceptModifier="", RetrieveConceptModifier="", spawnflags="", SearchType=0):
        ...
        self.WaitPointName = WaitPointName
        ...
        self.RetrieveDistance = RetrieveDistance
        ...
        self.SuccessDistance = SuccessDistance
        # Run instead of Walk : 
        self.Run = Run
        # Retrieve player? : 
        ...
        self.AttractPlayerConceptModifier = AttractPlayerConceptModifier
        ...
        self.WaitOverConceptModifier = WaitOverConceptModifier
        ...
        self.ArrivalConceptModifier = ArrivalConceptModifier
        # Post-arrival concepts modifier : 
        self.PostArrivalConceptModifier = PostArrivalConceptModifier
        ...
        self.ComingBackConceptModifier = ComingBackConceptModifier
        ...
        self.RetrieveConceptModifier = RetrieveConceptModifier
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
...
class AiGoalLeadWeapon(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", goal="", WaitPointName="", WaitDistance="", LeadDistance="64", RetrieveDistance="96", SuccessDistance="0", Run="0", Retrieve=1, ComingBackWaitForSpeak=1, RetrieveWaitForSpeak=1, DontSpeakStart=0, LeadDuringCombat=0, GagLeader=0, AttractPlayerConceptModifier="", WaitOverConceptModifier="", ArrivalConceptModifier="", PostArrivalConceptModifier="", SuccessConceptModifier="", FailureConceptModifier="", ComingBackConceptModifier="", RetrieveConceptModifier="", spawnflags="", WeaponName="weapon_bugbait", MissingWeaponConceptModifier="", SearchType=0):
        ...
        self.MissingWeaponConceptModifier = MissingWeaponConceptModifier
        # Search Type : How to search for the entities using the targetname.
        self.SearchType = SearchType
...
class AiGoalOperator(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, actor="", target="", contexttarget="", state=0, moveto=1):
...
class AiGoalPolice(Entity):
    ...
    AI Goal Police
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", angles="0 0 0", spawnflags="", policeradius=512, policetarget=""):
        ...
        self.policeradius = policeradius
        # Target : Target to police
        self.policetarget = policetarget
...
class AiGoalStandoff(Entity):
    ...
    AI Goal Standoff
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", actor="", SearchType=0, StartActive=0, HintGroupChangeReaction=1, Aggressiveness=2, PlayerBattleline=1, StayAtCover=0, AbandonIfEnemyHides=0):
...
class AiRelationship(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", subject="", target="", disposition=3, radius=0, rank=0, StartActive=0, Reciprocal=0, spawnflags=""):
...
class AiScriptConditions(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", Actor="", StartDisabled=1, MinimumState=1, MaximumState=3, ScriptStatus=2, RequiredTime=0, MinTimeout=0, MaxTimeout=0, ActorSeePlayer=2, PlayerActorProximity=0, PlayerActorFOV=360, PlayerActorFOVTrueCone=0, PlayerActorLOS=2, target="", ActorSeeTarget=2, ActorTargetProximity=0, PlayerTargetProximity=0, PlayerTargetFOV=360, PlayerTargetFOVTrueCone=0, PlayerTargetLOS=2, PlayerBlockingActor=2, ActorInPVS=2, ActorInVehicle=2, PlayerInVehicle=2, spawnflags=""):
        ...
        self.PlayerActorProximity = PlayerActorProximity
        # Player FOV for Actor  : Specify angle of view cone in degrees. Negative value = NOT
        self.PlayerActorFOV = PlayerActorFOV
...
class AiSound(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", volume=120, duration="0.5", soundtype=0, soundcontext=0, locationproxy=""):
        ...
        self.locationproxy = locationproxy
...
class AiscriptedSchedule(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", m_iszEntity="", m_flRadius=0, graball=0, spawnflags="", forcestate=0, schedule=1, interruptability=0, goalent=""):
...
class AssaultAssaultpoint(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", angles="0 0 0", assaultgroup="", nextassaultpoint="", assaulttimeout="3.0", clearoncontact=0, allowdiversion=0, allowdiversionradius=0, nevertimeout=0, strict=0, spawnflags="", forcecrouch=0, urgent=0, assaulttolerance=36):
        ...
        self.allowdiversionradius = allowdiversionradius
...
class AssaultRallypoint(Entity):
    ...
    (Assault) rally point
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", angles="0 0 0", assaultpoint="", assaultdelay=0, rallysequence="", priority=1, forcecrouch=0, urgent=0):
...
class CombineMine(Entity):
    ...
    Combine Land Mine
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", bounce=1, LockSilently=1, StartDisarmed=0, Modification=0):
...
class CyclerActor(Entity):
    ...
    Actor Cycler
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", damagefilter="", ResponseContext="", target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, disableshadows=0, model="", Sentence=""):
...
class EnvAlyxemp(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", angles="0 0 0", targetname="", parentname="", Type=0, EndTargetName=""):
        ...
        self.EndTargetName = EndTargetName
...
class EnvAr2explosion(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", material="particle/particle_noisesphere"):
...
class EnvCitadelEnergyCore(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", angles="0 0 0", targetname="", parentname="", spawnflags="", scale=1):
...
class EnvEntityDissolver(Entity):
    ...
    Entity Dissolver
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", target="", magnitude=250, dissolvetype="Energy"):
...
class EnvFlare(Entity):
    ...
    Flare
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", angles="0 0 0", scale=1, duration=30, spawnflags=""):
...
class EnvGlobal(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", initialstate=0, counter=0, spawnflags="", globalstate=""):
...
class EnvGunfire(Entity):
    ...
    Gunfire Effect
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", targetname="", StartDisabled=0, target="", minburstsize=2, maxburstsize=7, minburstdelay=2, maxburstdelay=5, rateoffire=10, spread=5, bias=1, collisions=0, shootsound="Weapon_AR2.NPC_Single", tracertype="AR2TRACER"):
        ...
        self.minburstsize = minburstsize
        ...
        self.minburstdelay = minburstdelay
        # Max Delay Between Bursts : Maximum delay between bursts. (seconds)
        self.maxburstdelay = maxburstdelay
...
class EnvHeadcrabcanister(Entity):
    ...
    Headcrab canister
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", angles="0 0 0", targetname="", spawnflags="", HeadcrabType=0, HeadcrabCount=6, FlightSpeed=3000, FlightTime=5, StartingHeight=0, MinSkyboxRefireTime=0, MaxSkyboxRefireTime=0, SkyboxCannisterCount=1, Damage=150, DamageRadius=750, SmokeLifetime=30, LaunchPositionName=""):
        ...
        self.HeadcrabCount = HeadcrabCount
        ...
        self.MinSkyboxRefireTime = MinSkyboxRefireTime
        ...
        self.LaunchPositionName = LaunchPositionName
...
class EnvMuzzleflash(Entity):
    ...
    Muzzle Flash
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", angles="0 0 0", parentattachment="", scale="1"):
...
class EnvSpeaker(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", ResponseContext="", delaymin="15", delaymax="135", spawnflags="", rulescript="", concept=""):
...
class EnvSporeexplosion(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", StartDisabled=0, spawnrate="25"):
...
class EnvTerrainmorph(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", startradius=500, goalradius=100, duration=3, fraction=1, spawnflags=""):
...
class FilterCombineballType(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", Negated="Allow entities that match criteria", balltype=1):
...
class FuncCombineBallSpawner(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", angles="0 0 0", globalname="", spawnflags="", ballcount=3, minspeed="300.0", maxspeed="600.0", ballradius="20.0", balltype="Combine Energy Ball 1", ballrespawntime="4.0f"):
...
class FuncHealthcharger(Entity):
    ...
    """
    def __init__(self, vmf_map, StartDisabled=0, parentname="", origin="", globalname="", _minlight=""):
...
class FuncLookdoor(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, movedir="0 0 0", startposition=0, speed=100, movedistance=100, blockdamage=0, startsound="", stopsound="", spawnflags="", ProximityDistance="0.0", ProximityOffset="0.0", FieldOfView="0.0"):
        ...
        self.ProximityOffset = ProximityOffset
...
class FuncMonitor(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", InputFilter=0, StartDisabled=0, disableshadows=0, spawnflags="", _minlight="", Solidity=0, excludednpc="", invert_exclusion=0, solidbsp=0, vrad_brush_cast_shadows=0, target=""):
...
class FuncRecharge(Entity):
    ...
    Battery recharger
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", _minlight="", spawnflags=""):
...
class FuncTank(Entity):
    ...
    Brush Gun Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, ammotype="", spawnflags=""):
        ...
        self.control_volume = control_volume
        # (Team) Master : 
        self.master = master
        # Yaw rate : 
        ...
        self.barrel = barrel
        # Barrel Horizontal : 
        self.barrely = barrely
        # Barrel Vertical : 
        self.barrelz = barrelz
        # Smoke Sprite : 
        self.spritesmoke = spritesmoke
        # Flash Sprite : 
        self.spriteflash = spriteflash
        # Sprite scale : 
        self.spritescale = spritescale
        # Rotate Start Sound : 
        self.rotatestartsound = rotatestartsound
        # Rotate Loop Sound : 
        self.rotatesound = rotatesound
        # Rotate Stop Sound : 
        self.rotatestopsound = rotatestopsound
        # Rate of Fire : 
        ...
        self.bullet_damage_vs_player = bullet_damage_vs_player
        ...
        self.gun_base_attach = gun_base_attach
        ...
        self.gun_barrel_attach = gun_barrel_attach
        ...
        self.gun_yaw_pose_param = gun_yaw_pose_param
        # Gun Yaw Pose Center : The center yaw pose parameter of the gun on the parent
        self.gun_yaw_pose_center = gun_yaw_pose_center
        ...
        self.gun_pitch_pose_param = gun_pitch_pose_param
        # Gun Pitch Pose Center : The center pitch pose parameter of the gun on the parent
        self.gun_pitch_pose_center = gun_pitch_pose_center
        ...
        self.npc_man_point = npc_man_point
...
class FuncTankCombineCannon(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, ammotype=""):
...
class FuncTankairboatgun(Entity):
    ...
    Airboat Gun Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, airboat_gun_model=""):
        ...
        self.airboat_gun_model = airboat_gun_model
...
class FuncTankapcrocket(Entity):
    ...
    APC Rocket Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, rocketspeed=800, burstcount=10):
...
class FuncTanklaser(Entity):
    ...
    Brush Laser Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, laserentity=""):
...
class FuncTankmortar(Entity):
    ...
    Brush Mortar Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, iMagnitude=100, firedelay=2, firestartsound="", fireendsound="", incomingsound="", warningtime="1", firevariance="0"):
        ...
        self.firestartsound = firestartsound
        # Firing end sound : 
        self.fireendsound = fireendsound
        # Incoming Shell Sound : Sound of the shell falling on the target
        self.incomingsound = incomingsound
        ...
        self.firevariance = firevariance
...
class FuncTankphyscannister(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, barrel_volume=""):
        ...
        self.barrel_volume = barrel_volume
...
class FuncTankpulselaser(Entity):
    ...
    Brush Pulse Laser
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, PulseSpeed=1000, PulseColor="255 0 0", PulseWidth="20", PulseLife=2, PulseLag="0.05", PulseFireSound=""):
...
class FuncTankrocket(Entity):
    ...
    Brush Rocket Turret
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, globalname="", disableshadows=0, spawnflags="", control_volume="", master="", yawrate="30", yawrange="180", yawtolerance="15", pitchrate="0", pitchrange="0", pitchtolerance="5", barrel="0", barrely="0", barrelz="0", spritesmoke="", spriteflash="", spritescale="1", rotatestartsound="", rotatesound="", rotatestopsound="", firerate="1", bullet_damage="0", bullet_damage_vs_player="0", persistence="1", persistence2="0", firespread=0, minRange="0", maxRange="0", _minlight="", gun_base_attach="", gun_barrel_attach="", gun_yaw_pose_param="", gun_yaw_pose_center="0", gun_pitch_pose_param="", gun_pitch_pose_center="0", ammo_count=-1, LeadTarget="No", npc_man_point="", playergraceperiod="0", ignoregraceupto="768", playerlocktimebeforefire="0", effecthandling=0, rocketspeed=800):
...
class FuncVehicleclip(Entity):
    ...
    Vehicle Clip
    """
    def __init__(self, vmf_map, parentname="", targetname="", globalname=""):
...
class GenericActor(Entity):
    ...
    Generic Actor NPC
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", damagefilter="", ResponseContext="", target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", parentname="", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, disableshadows=0, model="", hull_name="Human"):
...
class InfoApcMissileHint(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", angles="0 0 0", StartDisabled=0, target=""):
...
class InfoDarknessmodeLightsource(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, LightRadius="256.0"):
...
class InfoRadarTarget(Entity):
    ...
    Jalopy Radar Beacon
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", StartDisabled=0, radius=6000, type=0, mode=0):
...
class InfoSnipertarget(Entity):
    ...
    Sniper Target
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", speed=2, groupname="", spawnflags=""):
...
class InfoTargetGunshipcrash(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname=""):
...
class InfoTargetVehicleTransition(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", StartDisabled=0):
...
class ItemAmmo357(Entity):
    ...
    Box of 357 ammo
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", disableshadows=0, fademindist=-1, fademaxdist=0, fadescale=1, spawnflags=""):
...
class ItemAmmoCrate(Entity):
    ...
    Ammo Crate
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", fademindist=-1, fademaxdist=0, fadescale=1, AmmoType=0):
...
class ItemDynamicResupply(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", disableshadows=0, fademindist=-1, fademaxdist=0, fadescale=1, spawnflags="", DesiredHealth="1", DesiredArmor="0.3", DesiredAmmoPistol="0.5", DesiredAmmoSMG1="0.5", DesiredAmmoSMG1_Grenade="0.1", DesiredAmmoAR2="0.4", DesiredAmmoBuckshot="0.5", DesiredAmmoRPG_Round="0", DesiredAmmoGrenade="0.1", DesiredAmmo357="0", DesiredAmmoCrossbow="0", DesiredAmmoAR2_AltFire="0"):
        ...
        self.DesiredAmmoPistol = DesiredAmmoPistol
        ...
        self.DesiredAmmoSMG1 = DesiredAmmoSMG1
        ...
        self.DesiredAmmoSMG1_Grenade = DesiredAmmoSMG1_Grenade
        ...
        self.DesiredAmmoAR2 = DesiredAmmoAR2
        ...
        self.DesiredAmmoBuckshot = DesiredAmmoBuckshot
        ...
        self.DesiredAmmoRPG_Round = DesiredAmmoRPG_Round
        ...
        self.DesiredAmmoGrenade = DesiredAmmoGrenade
        ...
        self.DesiredAmmo357 = DesiredAmmo357
        ...
        self.DesiredAmmoCrossbow = DesiredAmmoCrossbow
        ...
        self.DesiredAmmoAR2_AltFire = DesiredAmmoAR2_AltFire
...
class ItemHealthcharger(Entity):
    ...
    Health Charger
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", fademindist=-1, fademaxdist=0, fadescale=1, _minlight=""):
...
class ItemItemCrate(Entity):
    ...
    Item Crate
    """
    def __init__(self, vmf_map, origin="0 0 0", globalname="", model="", skin=0, modelscale="1.0", disableshadows=0, ExplodeDamage=0, ExplodeRadius=0, PerformanceMode=0, BreakModelMessage="", pressuredelay=0, mindxlevel=0, maxdxlevel=0, spawnflags="", minhealthdmg=0, shadowcastdist=0, physdamagescale="0.1", Damagetype=0, nodamageforces=0, inertiaScale="1.0", massScale="0", overridescript="", damagetoenablemotion=0, forcetoenablemotion=0, puntsound="", targetname="", angles="0 0 0", damagefilter="", fademindist=-1, fademaxdist=0, fadescale=1, CrateType=0, CrateAppearance=0, ItemClass="item_dynamic_resupply", ItemCount=1, SpecificResupply=""):
        ...
        self.SpecificResupply = SpecificResupply
...
class ItemSuitcharger(Entity):
    ...
    Battery recharger
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", fademindist=-1, fademaxdist=0, fadescale=1, _minlight="", spawnflags=""):
...
class LogicAchievement(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", StartDisabled=0, AchievementEvent=0):
...
class LogicChoreographedScene(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", SceneFile="", target1="", target2="", target3="", target4="", target5="", target6="", target7="", target8="", busyactor=1, onplayerdeath=0):
        ...
        # Target 7 : 
        self.target7 = target7
        # Target 8 : 
        self.target8 = target8
...
class LogicSceneListManager(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", scene0="", scene1="", scene2="", scene3="", scene4="", scene5="", scene6="", scene7="", scene8="", scene9="", scene10="", scene11="", scene12="", scene13="", scene14="", scene15=""):
...
class MonsterGeneric(Entity):
    ...
    Generic Script NPC
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", damagefilter="", ResponseContext="", target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, disableshadows=0, spawnflags="", model="", body=0):
...
class NpcAdvisor(Entity):
    ...
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", model="models/advisor.mdl", levitationarea="", levitategoal_bottom="", levitategoal_top="", staging_ent_names="", priority_grab_name=""):
        ...
        self.priority_grab_name = priority_grab_name
...
class NpcAlyx(Entity):
    ...
    Alyx
    """
    def __init__(self, vmf_map, origin="0 0 0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, parentname="", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", AlwaysTransition="No", GameEndAlly="No", model="models/alyx.mdl", additionalequipment="weapon_alyxgun", DontPickupWeapons="1", ShouldHaveEMP="1"):
        ...
        # Use Sentence : 
        self.UseSentence = UseSentence
        # Un-Use Sentence : 
        self.UnUseSentence = UnUseSentence
...
class NpcAntlion(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", startburrowed="No", spawnflags="", radius=256, eludedist=1024, ignorebugbait="No", unburroweffects="No"):
...
class NpcAntlionGrub(Entity):
    ...
    Antlion grub
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", fademindist=-1, fademaxdist=0, fadescale=1, globalname="", spawnflags=""):
...
class NpcAntlionTemplateMaker(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", StartDisabled=1, MaxNPCCount=1, SpawnFrequency="5", MaxLiveChildren=5, spawnflags="", TemplateName="", spawngroup="", spawnradius=512, spawntarget="", fighttarget="", followtarget="", vehicledistance="1", workerspawnrate="0", ignorebugbait="0", pool_start=0, pool_max=0, pool_regen_amount=0, pool_regen_time=0, createspores="0"):
        ...
        self.pool_regen_amount = pool_regen_amount
        # Pool regen time. : Time interval between pool regeneration ticks.
        self.pool_regen_time = pool_regen_time
        # Create Spore effect : 
...
class NpcAntlionguard(Entity):
    ...
    Antlion Guard
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", startburrowed="No", allowbark="No", cavernbreed="No", incavern="No", shovetargets=""):
        ...
        # Shove Targets : 
        self.shovetargets = shovetargets
...
class NpcApcdriver(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", vehicle="", spawnflags="", drivermaxspeed=1, driverminspeed=0):
        ...
        self.drivermaxspeed = drivermaxspeed
        # MinSpeed (percentage of vehicle's maxspeed). : 
        self.driverminspeed = driverminspeed
...
class NpcBarnacle(Entity):
    ...
    Barnacle
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", fademindist=-1, fademaxdist=0, fadescale=1, spawnflags="", RestDist=16):
...
class NpcBarney(Entity):
    ...
    Barney
    """
    def __init__(self, vmf_map, origin="0 0 0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", additionalequipment="weapon_pistol", ExpressionOverride=""):
...
class NpcBreen(Entity):
    ...
    Dr Breen
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, model="models/breen.mdl", spawnflags=""):
...
class NpcBullseye(Entity):
    ...
    Bullseye
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", health=35, minangle="360", mindist="0", autoaimradius="0", spawnflags=""):
        ...
        self.autoaimradius = autoaimradius
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
...
class NpcCitizen(Entity):
    ...
    Citizen
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", spawnflags="", additionalequipment="0", ammosupply="SMG1", ammoamount=1, citizentype="Default", expressiontype="Random", model="models/humans/group01/male_01.mdl", ExpressionOverride="", notifynavfailblocked=0, neverleaveplayersquad=0, denycommandconcept=""):
        ...
        self.denycommandconcept = denycommandconcept
...
class NpcClawscanner(Entity):
    ...
    Claw Scanner
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", spotlightlength=500, spotlightwidth=50, spotlightdisabled=0, ShouldInspect=1, OnlyInspectPlayers=0, NeverInspectPlayers=0):
...
class NpcCombineCamera(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", innerradius=300, outerradius=450, minhealthdmg=0, defaulttarget=""):
...
class NpcCombinedropship(Entity):
    ...
    Combine Dropship
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", InitialSpeed="0", target="", spawnflags="", LandTarget="", GunRange=2048, RollermineTemplate="", NPCTemplate="", NPCTemplate2="", NPCTemplate3="", NPCTemplate4="", NPCTemplate5="", NPCTemplate6="", Dustoff1="", Dustoff2="", Dustoff3="", Dustoff4="", Dustoff5="", Dustoff6="", APCVehicleName="", Invulnerable=0, CrateType=2):
        ...
        self.RollermineTemplate = RollermineTemplate
        # Name of Template NPC 1 : 
        self.NPCTemplate = NPCTemplate
        # Name of Template NPC 2 : 
        self.NPCTemplate2 = NPCTemplate2
        # Name of Template NPC 3 : 
        self.NPCTemplate3 = NPCTemplate3
        # Name of Template NPC 4 : 
        self.NPCTemplate4 = NPCTemplate4
        # Name of Template NPC 5 : 
        self.NPCTemplate5 = NPCTemplate5
        # Name of Template NPC 6 : 
        self.NPCTemplate6 = NPCTemplate6
        # Name of dustoff point for NPC 1 : 
        self.Dustoff1 = Dustoff1
        # Name of dustoff point for NPC 2 : 
        self.Dustoff2 = Dustoff2
        # Name of dustoff point for NPC 3 : 
        self.Dustoff3 = Dustoff3
        # Name of dustoff point for NPC 4 : 
        self.Dustoff4 = Dustoff4
        # Name of dustoff point for NPC 5 : 
        self.Dustoff5 = Dustoff5
        # Name of dustoff point for NPC 6 : 
        self.Dustoff6 = Dustoff6
        # Name of the APC to drop : 
        self.APCVehicleName = APCVehicleName
        # Invulnerable : 
...
class NpcCombinegunship(Entity):
    ...
    Combine Gunship
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", InitialSpeed="0", target="", spawnflags=""):
...
class NpcEli(Entity):
    ...
    Eli Vance
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, parentname="", model="models/eli.mdl"):
...
class NpcEnemyfinder(Entity):
    ...
    EnemyFinder
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", FieldOfView="0.2", MinSearchDist=0, MaxSearchDist=2048, freepass_timetotrigger=0, freepass_duration=0, freepass_movetolerance=120, freepass_refillrate="0.5", freepass_peektime=0, StartOn=1):
        ...
        self.freepass_refillrate = freepass_refillrate
        # Player pass peek time : How long targets in cover are allowed to peek without penalty
        self.freepass_peektime = freepass_peektime
        # Start On : 
...
class NpcEnemyfinderCombinecannon(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", FieldOfView="0.2", MinSearchDist=0, MaxSearchDist=2048, SnapToEnt="", freepass_timetotrigger=0, freepass_duration=0, freepass_movetolerance=120, freepass_refillrate="0.5", freepass_peektime=0, StartOn=1):
...
class NpcHeadcrab(Entity):
    ...
    Headcrab
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", startburrowed="No", spawnflags="", parentname=""):
...
class NpcHeadcrabBlack(Entity):
    ...
    Black Headcrab
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", startburrowed="No", spawnflags=""):
...
class NpcHeliAvoidbox(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="", angles="0 0 0", parentname="", spawnflags=""):
...
class NpcHeliAvoidsphere(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", spawnflags="", radius=128):
...
class NpcHeliNobomb(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="", angles="0 0 0", parentname=""):
...
class NpcHelicopter(Entity):
    ...
    Helicopter
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", target="", spawnflags="", InitialSpeed="0", GracePeriod="2.0", PatrolSpeed="0", noncombat="No"):
...
class NpcLauncher(Entity):
    ...
    Launcher
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", StartOn=0, MissileModel="models/Weapons/wscanner_grenade.mdl", LaunchSound="npc/waste_scanner/grenade_fire.wav", FlySound="ambient/objects/machine2.wav", SmokeTrail=1, LaunchSmoke=1, LaunchDelay=8, LaunchSpeed=200, PathCornerName="", HomingSpeed=0, HomingStrength=10, HomingDelay=0, HomingRampUp="0.5", HomingDuration=5, HomingRampDown="1.0", Gravity="1.0", MinRange=100, MaxRange=2048, SpinMagnitude=0, SpinSpeed=0, Damage=50, DamageRadius=200):
        ...
        self.StartOn = StartOn
        # Missile Model : 
        self.MissileModel = MissileModel
        # Launch Sound : 
        self.LaunchSound = LaunchSound
        # Fly Sound : 
        self.FlySound = FlySound
        # Smoke Trail : 
        ...
        self.PathCornerName = PathCornerName
...
class NpcMaker(Entity):
    ...
    NPC Maker
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", StartDisabled=1, MaxNPCCount=1, SpawnFrequency="5", MaxLiveChildren=5, spawnflags="", NPCType="", NPCTargetname="", NPCSquadname="", NPCHintGroup="", additionalequipment="0"):
        ...
        # Childrens' Name : 
        self.NPCTargetname = NPCTargetname
        # Childrens' Squad Name : 
        self.NPCSquadname = NPCSquadname
        # Childrens' Hint Group : 
        self.NPCHintGroup = NPCHintGroup
        # Weapons : 
        self.additionalequipment = additionalequipment
...
class NpcManhack(Entity):
    ...
    Manhack
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", ignoreclipbrushes="0"):
...
class NpcMonk(Entity):
    ...
    Monk
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, additionalequipment="weapon_annabelle", HasGun=1):
...
class NpcRollermine(Entity):
    ...
    Roller Mine
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", startburied="No", uniformsightdist=0):
...
class NpcSniper(Entity):
    ...
    Sniper
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", radius=0, misses=0, beambrightness=100, shootZombiesInChest=0, shielddistance=64, shieldradius=48, PaintInterval=1, PaintIntervalVariance="0.75", spawnflags=""):
        ...
        self.beambrightness = beambrightness
        ...
        self.PaintInterval = PaintInterval
        ...
        self.PaintIntervalVariance = PaintIntervalVariance
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
...
class NpcSpotlight(Entity):
    ...
    Spotlight
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", spawnflags="", health=100, YawRange=90, PitchMin=35, PitchMax=50, IdleSpeed=2, AlertSpeed=5, spotlightlength=500, spotlightwidth=50, rendercolor="255 255 255"):
...
class NpcStrider(Entity):
    ...
    Strider
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", model="models/combine_strider.mdl", spawnflags="", disablephysics=0):
...
class NpcTurretCeiling(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", model="", skin=0, modelscale="1.0", disableshadows=0, spawnflags="", minhealthdmg=0):
...
class NpcTurretFloor(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", spawnflags="", SkinNumber=0):
...
class NpcVortigaunt(Entity):
    ...
    Vortigaunt
    """
    def __init__(self, vmf_map, origin="0 0 0", UseSentence="", UnUseSentence="", DontUseSpeechSemaphore=0, targetname="", angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0, damagefilter="", ResponseContext="", disableshadows=0, target="", squadname="", hintgroup="", hintlimiting=0, spawnflags="", sleepstate=0, wakeradius=0, wakesquad=0, enemyfilter="", ignoreunseenenemies=0, physdamagescale="1.0", AlwaysTransition="No", DontPickupWeapons="No", GameEndAlly="No", model="models/vortigaunt.mdl", ArmorRechargeEnabled=1, HealthRegenerateEnabled=0):
...
class PathCorner(Entity):
    ...
    Generic path point
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", spawnflags="", target="", wait=0, speed=0, yaw_speed=0):
...
class PlayerLoadsaved(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", duration="2", holdtime="0", renderamt=255, rendercolor="0 0 0", loadtime="0"):
...
class PlayerSpeedmod(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", spawnflags=""):
...
class PointAntlionRepellant(Entity):
    ...
    Antlion Repellant
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", repelradius=512):
...
class PointApcController(Entity):
    ...
    APC Controller
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", spawnflags="", yawrate="30", yawtolerance="15", pitchrate="0", pitchtolerance="20", rotatestartsound="", rotatesound="", rotatestopsound="", minRange="0", maxRange="0", targetentityname=""):
...
class PointBugbait(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", Enabled=1, spawnflags="", radius=512):
...
class PointCamera(Entity):
    ...
    Camera
    """
    def __init__(self, vmf_map, origin="0 0 0", parentname="", angles="0 0 0", spawnflags="", targetname="", FOV=90, UseScreenAspectRatio=0, fogEnable=0, fogColor="0 0 0", fogStart=2048, fogEnd=4096, fogMaxDensity=1):
...
class PointCombineBallLauncher(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", angles="0 0 0", globalname="", ballcount=3, minspeed="300.0", maxspeed="600.0", ballradius="20.0", balltype="Combine Energy Ball 1", ballrespawntime="4.0f", launchconenoise="0.0", bullseyename="", maxballbounces=8, spawnflags=""):
        ...
        self.launchconenoise = launchconenoise
        ...
        self.maxballbounces = maxballbounces
        # TODO: Replace this filler. : 
        self.spawnflags = spawnflags
...
class PointFleshEffectTarget(Entity):
    ...
    Flesh Effect Target
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", radius=8):
...
class PointPush(Entity):
    ...
    Point Push
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", spawnflags="", enabled=1, magnitude=100, radius=128, inner_radius="0"):
...
class PropScalable(Entity):
    ...
    Scalable Prop
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", model="", skin=0, modelscale="1.0", disableshadows=0, angles="0 0 0", renderfx=0, rendermode=0, renderamt=255, rendercolor="255 255 255", disablereceiveshadows=0):
...
class PropThumper(Entity):
    ...
    Thumper
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", model="models/props_combine/CombineThumper002.mdl", dustscale="Small Thumper", EffectRadius=1000):
...
class PropVehicle(Entity):
    ...
    def __init__(self, vmf_map, targetname="", origin="", globalname="", angles="0 0 0", mindxlevel=0, maxdxlevel=0, model="", skin=0, solid=6, disableshadows=0, screenspacefade=0, fademindist=-1, fademaxdist=0, fadescale=1, lightingorigin="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx=32, lightmapresolutiony=32, vehiclescript="scripts/vehicles/jeep_test.txt", actionScale="1", spawnflags=""):
        ...
        # Vehicle Script File : 
        self.vehiclescript = vehiclescript
...
class PropVehicleAirboat(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", globalname="", angles="0 0 0", mindxlevel=0, maxdxlevel=0, skin=0, solid=6, disableshadows=0, screenspacefade=0, fademindist=-1, fademaxdist=0, fadescale=1, lightingorigin="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx=32, lightmapresolutiony=32, actionScale="1", VehicleLocked=0, model="models/airboat.mdl", vehiclescript="scripts/vehicles/airboat.txt", EnableGun=0):
...
class PropVehicleApc(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", globalname="", angles="0 0 0", mindxlevel=0, maxdxlevel=0, model="", skin=0, solid=6, disableshadows=0, screenspacefade=0, fademindist=-1, fademaxdist=0, fadescale=1, lightingorigin="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx=32, lightmapresolutiony=32, vehiclescript="scripts/vehicles/jeep_test.txt", actionScale="1", VehicleLocked=0, missilehint=""):
...
class PropVehicleChoreoGeneric(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", globalname="", angles="0 0 0", mindxlevel=0, maxdxlevel=0, skin=0, solid=6, disableshadows=0, screenspacefade=0, fademindist=-1, fademaxdist=0, fadescale=1, lightingorigin="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx=32, lightmapresolutiony=32, actionScale="1", VehicleLocked=0, parentname="", model="models/vehicles/prisoner_pod.mdl", vehiclescript="scripts/vehicles/choreo_vehicle.txt", ignoremoveparent=0, ignoreplayer=0):
...
class PropVehiclePrisonerPod(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", origin="", globalname="", angles="0 0 0", mindxlevel=0, maxdxlevel=0, skin=0, solid=6, disableshadows=0, screenspacefade=0, fademindist=-1, fademaxdist=0, fadescale=1, lightingorigin="", disablevertexlighting=0, disableselfshadowing=0, ignorenormals=0, generatelightmaps=0, lightmapresolutionx=32, lightmapresolutiony=32, actionScale="1", VehicleLocked=0, parentname="", model="models/vehicles/prisoner_pod.mdl", vehiclescript="scripts/vehicles/prisoner_pod.txt"):
...
class ScriptIntro(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", alternatefovchange=0):
...
class ScriptTauremoval(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", angles="0 0 0", targetname="", parentname="", vortigaunt=""):
...
class ScriptedSentence(Entity):
    ...
    Scripted Sentence
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", spawnflags="", sentence="", entity="", delay="0", radius=512, refire="3", listener="", volume="10", attenuation=0):
...
class ScriptedSequence(Entity):
    ...
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", m_iszEntity="", m_iszIdle="", m_iszEntry="", m_iszPlay="", m_iszPostIdle="", m_iszCustomMove="", m_bLoopActionSequence=0, m_bSynchPostIdles=0, m_flRadius=0, m_flRepeat=0, m_fMoveTo=1, m_iszNextScript="", m_bIgnoreGravity=0, m_bDisableNPCCollisions=0, angles="0 0 0", mindxlevel=0, maxdxlevel=0, spawnflags="", onplayerdeath=0):
        ...
        self.m_iszPostIdle = m_iszPostIdle
        ...
        self.m_iszCustomMove = m_iszCustomMove
        ...
        self.m_iszNextScript = m_iszNextScript
...
class ScriptedTarget(Entity):
    ...
    Scripted Target
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", parentname="", StartDisabled=1, m_iszEntity="", m_flRadius=0, MoveSpeed=5, PauseDuration=0, EffectDuration=2, target=""):
...
class TriggerPhysicsTrap(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", StartDisabled=0, globalname="", spawnflags="", filtername="", angles="0 0 0", dissolvetype="Energy"):
...
class TriggerVphysicsMotion(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", globalname="", spawnflags="", StartDisabled=0, filtername="", SetGravityScale="1.0", SetAdditionalAirDensity="0", SetVelocityLimit="0.0", SetVelocityLimitDelta="0.0", SetVelocityScale="1.0", SetAngVelocityLimit="0.0", SetAngVelocityScale="1.0", SetLinearForce="0.0", SetLinearForceAngles="0 0 0", ParticleTrailMaterial="", ParticleTrailLifetime=4, ParticleTrailStartSize=2, ParticleTrailEndSize=3):
...
class TriggerWeaponDissolve(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", StartDisabled=0, globalname="", spawnflags="", filtername="", emittername=""):
...
class TriggerWeaponStrip(Entity):
    ...
    """
    def __init__(self, vmf_map, targetname="", parentname="", origin="", StartDisabled=0, globalname="", spawnflags="", filtername="", KillWeapons="No"):
...
class WeaponBrickbat(Entity):
    ...
    Brickbat
    """
    def __init__(self, vmf_map, origin="0 0 0", targetname="", angles="0 0 0", spawnflags="", fademindist=-1, fademaxdist=0, fadescale=1, BrickbatType="Rock"):
...
class WeaponStriderbuster(Entity):
    ...
    Strider Buster
    """
    def __init__(self, vmf_map, origin="0 0 0", globalname="", angles="0 0 0", model="", skin=0, modelscale="1.0", targetname="", damagefilter="", disableshadows=0, ExplodeDamage=0, ExplodeRadius=0, PerformanceMode=0, BreakModelMessage="", pressuredelay=0, mindxlevel=0, maxdxlevel=0, fademindist=-1, fademaxdist=0, fadescale=1, minhealthdmg=0, shadowcastdist=0, physdamagescale="0.1", Damagetype=0, nodamageforces=0, inertiaScale="1.0", massScale="0", overridescript="", damagetoenablemotion=0, forcetoenablemotion=0, puntsound="", spawnflags="", dud=0):
